...
variable "subscription_id" {
  description = "Azure Subscription ID used for this resource."
  type        = string
}
...
variable "order" {
  type        = number
  description = "Order as a tag to be associated with an Azure resource"
...
variable "dataclassification" {
  type        = string
  description = "Classification of data - can be made conditionally required based on Compliance. One of the following: Public, Internal, Confidential, Restricted, Privileged, BCSI, BCSI-Confidential, BCSI-Restricted (only one)"
  default     = "Internal"

  validation {
    condition     = contains(["Public", "Internal", "Confidential", "Restricted", "Privileged", "BCSI", "BCSI-Confidential", "BCSI-Restricted"], var.dataclassification)
    error_message = "Valid values for DataClassification are (Public, Internal, Confidential, Restricted, Privileged, BCSI, BCSI-Confidential, BCSI-Restricted). Please select on these as DataClassification parameter."
  }
}
...
variable "compliance" {
  ...
  validation {
    ...
    error_message = "Valid values for Compliance are SOX, HIPAA, CCPA, BCSI or None. Please select on these as Compliance parameter."
  }
}
