...
### SSM Document
variable "ssm_portal_config_document_name" {
  type        = string
  description = "SSM document name"
}

variable "ssm_server_config_document_name" {
  type        = string
  description = "SSM document name"
}

variable "ssm_webadaptor_config_document_name" {
  type        = string
  description = "SSM document name"
}

variable "ssm_datastore_config_document_name" {
  type        = string
  description = "SSM document name"
}

variable "ssm_command_document_type" {
  type        = string
  description = "The type of the document. Valid document types include: Automation, Command, Package, Policy, and Session"
  default = "Command"
}

variable "ssm_automation_document_type" {
  type        = string
  description = "The type of the document. Valid document types include: Automation, Command, Package, Policy, and Session"
  default = "Automation"
}
