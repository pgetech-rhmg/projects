...

    {
      ...
      "inputs": {
        "runCommand": [
          ...
          "",
          "echo '${dataStore}' | base64 --decode > /opt/cinc/attributes/arcgis-datastore-primary.json",
          "cinc-client -z -c /etc/cinc/client.rb -j /opt/cinc/attributes/arcgis-datastore-primary.json 2>&1 | tee -a \"$LOG_DIR/arcgis-datastore-primary.log\"",
          "RC=$${PIPESTATUS[0]}",
