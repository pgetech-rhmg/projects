...
variable "parameter_subnet_cidr1_id" {
  ...
  #default     = "/vpc/2/privatesubnet1/cidr"
...
variable "parameter_subnet_cidr2_id" {
  ...
  #default     = "/vpc/2/privatesubnet2/cidr"
...
variable "parameter_subnet_cidr3_id" {
  ...
  #default     = "/vpc/2/privatesubnet3/cidr"
}
...
variable "jfrog_password" {
  type        = string
  description = "password of Jfrog password stored in aws_ssm_parameter"
...
variable "port_mappings_for_fluentbit" {
  type = list(object({
    containerPort = number
    hostPort      = number
    protocol      = string
