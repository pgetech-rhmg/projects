...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lmtfcrun"></a> [lmtfcrun](#module\_lmtfcrun) | ../../ | n/a |
...
| <a name="input_create_lmtfcrun"></a> [create\_lmtfcrun](#input\_create\_lmtfcrun) | Whether to create a Lambda instance | `bool` | `false` | no |
