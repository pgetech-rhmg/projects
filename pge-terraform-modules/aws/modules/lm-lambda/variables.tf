##################################################################
#
#  Filename    : aws/modules/lm-lambda/variables.tf
#  Date        : 15 May 2025
...
variable "lambda_permissions" {
  description = "List of Lambda permissions to create"
  type = list(object({
...
variable "subnets" {
  type        = list(string)
  description = "The name of the SSM Parameters that comtain the subnet ids."
