...
Creates an image lambda for Locate & Mark. It ignores changes to the image_url/tag.
...
| [aws_lambda_permission.lambda_alias_permission](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_permission) | resource |
...
| <a name="input_cloudwatch_log_group_retention_in_days"></a> [cloudwatch\_log\_group\_retention\_in\_days](#input\_cloudwatch\_log\_group\_retention\_in\_days) | The number of days to retain logs in CloudWatch Log Group | `number` | `90` | no |
...
| <a name="input_lambda_permissions"></a> [lambda\_permissions](#input\_lambda\_permissions) | List of Lambda permissions to create | <pre>list(object({<br/>    statement_id       = optional(string)<br/>    action             = optional(string, "lambda:InvokeFunction")<br/>    event_source_token = optional(string)<br/>    principal          = string<br/>    source_account     = optional(string)<br/>    source_arn         = optional(string)<br/>  }))</pre> | `[]` | no |
...
| <a name="input_role_inline_policies"></a> [role\_inline\_policies](#input\_role\_inline\_policies) | List of IAM policy documents to attach to the role | `list(string)` | `[]` | no |
| <a name="input_role_policies"></a> [role\_policies](#input\_role\_policies) | List of IAM policy arns to attach to the role | `list(string)` | `[]` | no |
...
| <a name="input_subnets"></a> [subnets](#input\_subnets) | The name of the SSM Parameters that comtain the subnet ids. | `list(string)` | <pre>[<br/>  "/vpc/privatesubnet1/id",<br/>  "/vpc/privatesubnet2/id",<br/>  "/vpc/privatesubnet3/id"<br/>]</pre> | no |
...
| <a name="input_vpc_config_security_group_ids"></a> [vpc\_config\_security\_group\_ids](#input\_vpc\_config\_security\_group\_ids) | List of security group IDs associated with the Lambda function | `list(string)` | `[]` | no | 

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_alias_arn"></a> [alias\_arn](#output\_alias\_arn) | ARN of the Lambda Function Latest Alias |
...
| <a name="output_ecr_arn"></a> [ecr\_arn](#output\_ecr\_arn) | Full ARN of the ECR repository. |
| <a name="output_ecr_id"></a> [ecr\_id](#output\_ecr\_id) | Id of the ECR registry. |
| <a name="output_ecr_url"></a> [ecr\_url](#output\_ecr\_url) | URL of the ECR repository. |
...
| <a name="output_lambda_execution_role_arn"></a> [lambda\_execution\_role\_arn](#output\_lambda\_execution\_role\_arn) | IAM role ARN for Lambda execution |
...
| <a name="output_vpc_config_vpc_id"></a> [vpc\_config\_vpc\_id](#output\_vpc\_config\_vpc\_id) | ID of the VPC |
