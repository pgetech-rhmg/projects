...
Terraform module which creates Transfer server for efs in AWS.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_efs"></a> [efs](#module\_efs) | app.terraform.io/pgetech/efs/aws | 0.1.1 |
...
| <a name="module_security_group_efs"></a> [security\_group\_efs](#module\_security\_group\_efs) | app.terraform.io/pgetech/security-group/aws | 0.1.2 |
...
| <a name="input_gid"></a> [gid](#input\_gid) | The POSIX group ID used for all EFS operations by this user. | `number` | n/a | yes |
...
| <a name="input_secondary_gids"></a> [secondary\_gids](#input\_secondary\_gids) | The secondary POSIX group IDs used for all EFS operations by this user. | `list(string)` | n/a | yes |
...
| <a name="input_uid"></a> [uid](#input\_uid) | The POSIX user ID used for all EFS operations by this user. | `number` | n/a | yes | 
