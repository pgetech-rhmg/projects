run "codepipeline_ecs_rollback" {
  command = apply

  module {
    source = "./examples/codepipeline_ecs_rollback"
  }
}
...
variables {
  ...
  codepipeline_name                         = "spring-petclinic-rb-ecs"
  github_org                                = "pgetech"
  ...
  rollback_image_tag                = "ccoe-cicd-docker-virtual.jfrog.nonprod.pge.com/spring-petclinic:pge-1.0.0"
