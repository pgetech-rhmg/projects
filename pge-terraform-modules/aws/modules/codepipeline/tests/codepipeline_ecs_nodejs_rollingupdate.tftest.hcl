run "codepipeline_ecs_nodejs_rollingupdate" {
  command = apply

  module {
    source = "./examples/codepipeline_ecs_nodejs_rollingupdate"
  }
}
...
variables {
  ...
  codepipeline_name                       = "pge-container-nodeecs-m7k3"
  github_org                              = "pgetech"
  repo_name                               = "nodejs-webapp"
  branch                                  = "main"
  project_key                             = "pge-container-nodeecs-m7k3"
  project_name                            = "pge-container-nodeecs-m7k3"
  ...
  ssm_parameter_artifactory_docker_repo   = "/jfrog/ccoe-cicd/docker-registry"
  ...
  source_location_codetest                = "https://github.com/pgetech/nodejs-webapp"
  ...
  kms_name                = "codebuild_key_nodejs-m7k3"
  ...
  ecs_cluster_name        = "ecs-fargate-cluster-nrb"
  ecs_service_name        = "ecs-fargate-service-nrb"
