run "codepipeline_python" {
  command = apply

  module {
    source = "./examples/codepipeline_python"
  }
}
...
variables {
  ...
  codepipeline_name                       = "codepipeline-python"
  github_org                              = "pgetech"
  repo_name                               = "terraform-cicd-pipeline-ref"
  branch                                  = "MounikaKota9-pytest"
  project_key                             = "codepipeline-python-ccoe-test"
  project_name                            = "codepipeline-python-ccoe-test"
  ...
  sg_name                                 = "sg_codebuild_project_python"
  ...
  codedeploy_app_name           = "codepipeline-python"
  deployment_tag_key            = "Name"
  deployment_tag_value          = "ec2-python-deploy-cp"
