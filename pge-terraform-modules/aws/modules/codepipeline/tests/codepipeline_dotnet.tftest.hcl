run "codepipeline_dotnet" {
  command = apply

  module {
    source = "./examples/codepipeline_dotnet"
  }
}
...
variables {
  ...
  codepipeline_name                       = "codepipeline-dotnet-ccoe-0910"
  github_org                              = "pgetech"
  ...
  project_name                            = "sample-dotnet-ccoe-5383"
  project_key                             = "sample-dotnet-ccoe-5383"
  ...
  sg_name_codebuild        = "sg_codebuild_codetest_project_dotnet"
  ...
  codedeploy_app_name           = "codepipeline-dotnet-ec2"
