run "codepipeline_java" {
  command = apply

  module {
    source = "./examples/codepipeline_java"
  }
}
...
variables {
  ...
  codepipeline_name                       = "codepipeline-java-ccoe-test"
  github_org                              = "pgetech"
  ...
  bucket_name                             = "codepipeline-bucket-java-ccoe-test"
  ...
  codetest_role_name                      = "codetest_java_iam_policy_test"
  ...
  sg_name                                 = "sg_codebuild_project_java_test"
  ...
  sg_name_codebuild        = "sg_codebuild_codetest_project_java-ccoe-test"
  ...
  kms_name           = "codebuild_key_java_test"
  kms_description    = "kms key for codebuild java"
  sg_name_ec2        = "ec2-sg-ccoe-test"
  ...
  codedeploy_app_name           = "codepipeline-java-test"
