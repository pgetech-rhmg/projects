run "codepipeline_s3web_angular" {
  command = apply

  module {
    source = "./examples/codepipeline_s3web_angular"
  }
}
...
variables {
  ...
  codepipeline_name                       = "codepipeline-s3web-cco3-6883"
  ...
  github_repo_url                         = "https://github.com/pgetech/s3web-angular-yarn.git"
  github_branch                           = "main"
