run "codepipeline_s3web_react" {
  command = apply

  module {
    source = "./examples/codepipeline_s3web_react"
  }
}
...
variables {
  ...
  codepipeline_name                       = "codepipeline-s3web-react-ccoe-6883"
