...
*/
#
#  Filename    :  aws/modules/codepipeline/modules/codepipeline_terraform/main.tf
#  Date        : 20 Nov 2023
#  Author      : sycz@pge.com
#  Description : creation of codepipeline module from codepipeline_terraform, this module allows to generate terraform code using terrafrunt + Sonarqube scanning 
#  of Terraform source code, this is generic module and can be used in any Git repo has terraform code in it. 
#
