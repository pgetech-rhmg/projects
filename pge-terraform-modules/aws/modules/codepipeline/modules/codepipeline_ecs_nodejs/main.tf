...
*/
#
#  Filename    :  aws/modules/codepipeline/modules/codepipeline_container_ecs/main.tf
#  Date        : 03 November 2022
#  Author      : Tekyantra
#  Description : Codepipeline module to create pipeline for ecs nodejs application.
#
