...
*/
#
#  Filename    : aws/modules/codepipeline/modules/codepipeline_ecs_nodejs/main.tf
#  Date        : 03 Nov 2022 
#  Author      : Tekyantra
#  Description : Codepipeline module for the nodejs application
# 
...
module "codebuild_codescan" {
  ...
  environment_variables = concat([
    ...
    },
    {
      ...
      value = var.artifactory_nodejs_repo
      type  = "PLAINTEXT"
    },
    {
      name  = "SONAR_TOKEN"
    ...
    {
      name  = "RUNTIME_VERSION_CODESCAN"
      value = var.runtime_version_codescan
      type  = "PLAINTEXT"
    },
    {
...
module "codebuild_twistlock" {
  ...
  environment_variables = concat([
    ...
    },
    {
      ...
      value = var.artifactory_docker_repo
      type  = "PLAINTEXT"
    },
    {
