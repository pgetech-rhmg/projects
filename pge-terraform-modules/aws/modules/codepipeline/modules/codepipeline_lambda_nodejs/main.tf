...
*/
#  Filename    : aws/modules/codepipeline/modules/codepipeline_lambda_node/main.tf
#  Date        : 22 August 2022
#  Author      : PGE
...
resource "aws_codepipeline" "codepipeline" {
  ...
  # Stage 4 Publish artifact to jfrog and update lambda function 
  ...
  #In order to work around this limitation, we are Running AWS CLI commands inside CodeBuild Stage to update/deploy lambda function
  stage {
    name = "Publish"
