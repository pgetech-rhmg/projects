<!-- BEGIN_TF_DOCS -->
# AWS codepipeline lambda module for node
...
| <a name="input_node_runtime_codescan"></a> [node\_runtime\_codescan](#input\_node\_runtime\_codescan) | Enter the nodejs version value for codescan, Minimum of node18 version is required to run sonarscan. Latest LTS is 20 which is recommended | `string` | `"20"` | no |
...
| <a name="input_unit_test_commands"></a> [unit\_test\_commands](#input\_unit\_test\_commands) | Enter the unit test commands for node webapp | `string` | n/a | yes |
