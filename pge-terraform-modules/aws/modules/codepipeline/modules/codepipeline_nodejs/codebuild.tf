...
locals {
  ...
  codescan_inline_policy    = var.custom_codescan_policy_file != null ? concat([file(var.custom_codescan_policy_file)], [file("${path.module}/codebuild_iam_policies/codescan_iam_policy.json")]) : [file("${path.module}/codebuild_iam_policies/codescan_iam_policy.json")]
  codepublish_inline_policy = var.custom_codepublish_policy_file != null ? concat([file(var.custom_codepublish_policy_file)], [file("${path.module}/codebuild_iam_policies/codepublish_iam_policy.json")]) : [file("${path.module}/codebuild_iam_policies/codepublish_iam_policy.json")]
}
