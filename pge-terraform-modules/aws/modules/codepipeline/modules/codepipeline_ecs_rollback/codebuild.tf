...
*/
#
#  Filename    :  aws/modules/codepipeline/modules/codepipeline_ecs_rollback/codebuild.tf
#  Date        : 12-19-2022
#  Author      : Tekyantra
...
module "codebuild_rollback_config" {
  ...
  codebuild_project_role       = module.twistlock_scan_iam_role.arn
...
module "twistlock_scan_iam_role" {
