...
*/
#
#  Filename    : aws/modules/codepipeline/modules/codepipeline_s3web_angular/main.tf
#  Date        : 08 Sep 2022
#  Author      : pge
#  Description : creation of angular codepipeline module for s3 web
#
...
data "external" "validate_kms" {
  count   = (var.tags["DataClassification"] != "Internal" && var.tags["DataClassification"] != "Public" && local.kms_key_arn == null) ? 1 : 0
