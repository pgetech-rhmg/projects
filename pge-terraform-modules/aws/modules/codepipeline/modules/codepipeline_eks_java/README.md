...
| <a name="input_Notify"></a> [Notify](#input\_Notify) | Who to notify for system failure or maintenance and docker image owners. Should be a group or list of email addresses. | `string` | n/a | yes |
...
| <a name="input_codestar_sns_kms_key_arn"></a> [codestar\_sns\_kms\_key\_arn](#input\_codestar\_sns\_kms\_key\_arn) | codestar kms key arn | `string` | `""` | no |
...
| <a name="input_is_eks_fargate"></a> [is\_eks\_fargate](#input\_is\_eks\_fargate) | To embed twistlock defender if the cluster is EKS fargate | `bool` | n/a | yes |
| <a name="input_java_runtime"></a> [java\_runtime](#input\_java\_runtime) | Enter the java runtime version for codescan stage - variable in buildspec yml | `string` | n/a | yes |
...
| <a name="input_kms_key_arn"></a> [kms\_key\_arn](#input\_kms\_key\_arn) | Enter the KMS key arn for encryption - codebuild | `string` | n/a | yes |
...
| <a name="input_publish_docker_registry"></a> [publish\_docker\_registry](#input\_publish\_docker\_registry) | Please enter ECR, JFROG or BOTH to publish docker images | `string` | `"JFROG"` | no |
...
| <a name="input_twistlock_console_host"></a> [twistlock\_console\_host](#input\_twistlock\_console\_host) | To embed twistlock defender if the cluster is EKS fargate | `string` | `"us-east1.cloud.twistlock.com"` | no |
