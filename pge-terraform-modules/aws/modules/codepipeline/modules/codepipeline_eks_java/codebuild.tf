...
*/
#
#  Filename    :  aws/modules/codepipeline/modules/codepipeline_eks_java/codebuild.tf
#  Date        : 04 Nov 2022
#  Author      : Tekyantra
#  Description : creation of codepipeline module from codepipeline_eks_Java
#
...
module "codebuild_twistlock" {
  ...
  environment_variables = concat([
    ...
    {
      name  = "TWISTLOCK_CONSOLE_HOST"
      value = var.twistlock_console_host
      type  = "PLAINTEXT"
    },
