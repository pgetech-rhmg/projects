...
| <a name="module_security-group-snslambda"></a> [security-group-snslambda](#module\_security-group-snslambda) | app.terraform.io/pgetech/security-group/aws | 0.1.1 |
...
| [local_file.lambda_func](https://registry.terraform.io/providers/hashicorp/local/latest/docs/resources/file) | resource |
...
| <a name="input_codestar_environment"></a> [codestar\_environment](#input\_codestar\_environment) | lambda environment | `string` | `"dev"` | no |
