...
| <a name="input_artifactory_maven_repo"></a> [artifactory\_maven\_repo](#input\_artifactory\_maven\_repo) | Enter the name value of jfrog artifactory | `string` | n/a | yes |
