...
variable "unit_test_commands" {
  description = "Unit test commands to test nodejs webapp application"
  type        = string
}
...
variable "artifactory_helm_local_repo" {
  description = "Name of jfrog artifactory helm chart virtual group name storedin ssm parameter"
  type        = string
}
...
variable "secretsmanager_twistlock_user_id" {
  description = "Twistlock user stored in secrets manager"
  type        = string
}

variable "secretsmanager_twistlock_token" {
  description = "Twistlock token stored in secrets manager"
  type        = string
}

variable "twistlock_console" {
  description = "Twistlock Console url"
  type        = string
}
...
variable "Environment" {
  ...
  validation {
    ...
    error_message = "Valid values for  s are Dev, QA, UAT or PROD ."
  }
}
