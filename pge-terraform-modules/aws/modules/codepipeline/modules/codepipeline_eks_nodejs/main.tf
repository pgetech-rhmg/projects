...
*/
#
#  Filename    :  aws/modules/codepipeline/modules/codepipeline_eks_nodejs/main.tf
#  Date        : 03 November 2022
#  Author      : Tekyantra
#  Description : Codepipeline module to create pipeline for eks nodejs application.
#
...
resource "aws_codepipeline" "codepipeline" {
  ...
  stage {
    ...
    action {
      ...
      version          = "1"
      input_artifacts  = ["build"]
      output_artifacts = ["twistlock-scan"]
      region           = var.region
      configuration = {
