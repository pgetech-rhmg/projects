...
*/
#
#  Filename    : aws/modules/codepipeline/examples/codepipeline_ecs_python_rollingupdate/main.tf
...
module "codepipeline" {
  source             = "../../modules/codepipeline_ecs_python"
  codepipeline_name  = var.codepipeline_name
  ...
  environment_variables_codebuild_stage = [
    ...
    },
    {
      ...
      value = data.aws_ssm_parameter.artifactory_python_repo.value
      type  = "PLAINTEXT"
    },
  ...
  artifactory_python_repo     = data.aws_ssm_parameter.artifactory_python_repo.value
