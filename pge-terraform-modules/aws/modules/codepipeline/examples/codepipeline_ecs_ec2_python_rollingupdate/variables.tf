...
variable "ssm_parameter_artifactory_python_repo" {
...
variable "container_name" {
  description = "Enter the name of the container name. It should match the container name while creating the clusters"
  type        = string
}
