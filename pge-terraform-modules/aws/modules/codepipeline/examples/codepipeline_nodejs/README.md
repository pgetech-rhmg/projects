...
| <a name="module_codepipeline"></a> [codepipeline](#module\_codepipeline) | ../../modules/codepipeline_nodejs | n/a |
...
| <a name="input_artifact_name_nodejs"></a> [artifact\_name\_nodejs](#input\_artifact\_name\_nodejs) | Enter the name of artifact | `string` | n/a | yes |
