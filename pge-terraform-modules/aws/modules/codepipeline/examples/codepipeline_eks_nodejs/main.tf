...
* # Prerequisites : In the variables 'ssm_parameter_vpc_id', 'ssm_parameter_subnet_id1/2/3', 'ssm_parameter_artifactory_host', 'ssm_parameter_artifactory_nodejs_repo', 'ssm_parameter_sonar_host', 'ssm_parameter_twistlock_console', 'ssm_parameter_environment', 'ssm_parameter_artifactory_docker_registry', 'secretsmanager_github_token_secret_name', 'secretsmanager_artifactory_token','secretsmanager_artifactory_user', 'secretsmanager_sonar_token', 'secretsmanager_twistlock_user_id', 'secretsmanager_twistlock_token'.  Provide the suitable values respectively in tfvars.
* # Code verified using terraform validate and terraform fmt -check.
*/
#
#  Filename    : aws/modules/codepipeline/examples/codepipeline_eks_nodejs/main.tf
...
module "codepipeline" {
  source             = "../../modules/codepipeline_eks_nodejs"
  codepipeline_name  = var.codepipeline_name
