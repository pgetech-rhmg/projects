...
| <a name="module_codepipeline"></a> [codepipeline](#module\_codepipeline) | ../../modules/codepipeline_dotnet | n/a |
...
| <a name="input_build_args"></a> [build\_args](#input\_build\_args) | Provide the build environment variables required for codebuild | `string` | `""` | no |
