...
*/
#
#  Filename    : aws/modules/codepipeline/examples/codepipeline_dotnet/main.tf
#  Date        : 28 April 2022
#  Author      : TCS
...
module "codepipeline" {
  source            = "../../modules/codepipeline_dotnet"
...
module "codepipeline_iam_role" {
  ...
  name        = "codepipeline_${var.codepipeline_name}_iam_role" #var.codepipeline_role_name
