...
variable "build_file_path_location" {
  description = "Enter the dotnet project build file path location. This path is respective to the project root directory"
  type        = string
  default     = "."
}
...
variable "unit_test_commands" {
  description = "Enter the unit test commands for dotnet app"
  type        = string
}
...
variable "dotnet_lambda_runtime" {
