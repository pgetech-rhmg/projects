...
variable "unit_test_commands" {
  description = "Enter the unit test commands for nodejs webapp"
  type        = string
}
...
variable "ssm_parameter_artifactory_nodejs_repo" {
  description = "Enter the name value of jfrog artifactory stored in ssm parameter"
  type        = string
}

variable "ssm_parameter_artifactory_docker_repo" {
  description = "Enter the name value of jfrog artifactory stored in ssm parameter"
  type        = string
}
...
variable "deployment_stage_name" {
  description = "Enter deployment Application stage name"
  type        = string
}
...
variable "deployment_timeout" {
  description = "Please enter code deployment timeout"
  type        = number
}
...
variable "container_name" {
  description = "Enter the name of the container name. It should match the container name while creating the cluster."
  type        = string
}
...
variable "codestar_environment" {
  type        = string
  description = "The environment is used for codestar notifications such as Dev, Test, QA, Prod."
}
