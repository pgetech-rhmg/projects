...
# Prerequisites : In the variables 'ssm\_parameter\_vpc\_id', 'ssm\_parameter\_subnet\_id1/2/3', 'ssm\_parameter\_artifactory\_host', 'ssm\_parameter\_artifactory\_nodejs\_repo', 'ssm\_parameter\_sonar\_host', 'ssm\_parameter\_twistlock\_console', 'ssm\_parameter\_environment', 'ssm\_parameter\_artifactory\_docker\_repo', 'secretsmanager\_github\_token\_secret\_name', 'secretsmanager\_artifactory\_token','secretsmanager\_artifactory\_user', 'secretsmanager\_sonar\_token', 'secretsmanager\_twistlock\_user\_id', 'secretsmanager\_twistlock\_token'.  Provide the suitable values respectively in tfvars.
...
| <a name="module_codepipeline"></a> [codepipeline](#module\_codepipeline) | ../../modules/codepipeline_ecs_nodejs | n/a |
...
| [aws_ssm_parameter.artifactory_docker_repo](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ssm_parameter) | data source |
...
| [aws_ssm_parameter.artifactory_nodejs_repo](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ssm_parameter) | data source |
...
| <a name="input_build_command"></a> [build\_command](#input\_build\_command) | Enter the build or install command to build nodejs webapp application | `string` | n/a | yes |
...
| <a name="input_codedeploy_provider"></a> [codedeploy\_provider](#input\_codedeploy\_provider) | Enter CodeDeploy Provider name for ECS Deployment strategies | `string` | `""` | no |
...
| <a name="input_deployment_stage_name"></a> [deployment\_stage\_name](#input\_deployment\_stage\_name) | Enter deployment Application stage name | `string` | n/a | yes |
| <a name="input_deployment_timeout"></a> [deployment\_timeout](#input\_deployment\_timeout) | Please enter code deployment timeout | `number` | n/a | yes |
| <a name="input_ecs_cluster_name"></a> [ecs\_cluster\_name](#input\_ecs\_cluster\_name) | Enter ECS Cluster name | `string` | n/a | yes |
...
| <a name="input_runtime_version"></a> [runtime\_version](#input\_runtime\_version) | Enter the runtime version of node - variable in buildspec yml | `string` | n/a | yes |
...
| <a name="input_ssm_parameter_artifactory_docker_repo"></a> [ssm\_parameter\_artifactory\_docker\_repo](#input\_ssm\_parameter\_artifactory\_docker\_repo) | Enter the name value of jfrog artifactory stored in ssm parameter | `string` | n/a | yes |
...
| <a name="input_ssm_parameter_artifactory_nodejs_repo"></a> [ssm\_parameter\_artifactory\_nodejs\_repo](#input\_ssm\_parameter\_artifactory\_nodejs\_repo) | Enter the name value of jfrog artifactory stored in ssm parameter | `string` | n/a | yes |
