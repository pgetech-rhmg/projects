...
*/
#
#  Filename    : aws/modules/codepipeline/modules/codepipeline_ecs_nodejs_rollingupdate/data.tf
...
data "aws_ssm_parameter" "artifactory_nodejs_repo" {
  name = var.ssm_parameter_artifactory_nodejs_repo
}

data "aws_ssm_parameter" "artifactory_docker_repo" {
  name = var.ssm_parameter_artifactory_docker_repo
}
