...
# Prerequisites : In the variables 'ssm\_parameter\_github\_oauth\_token','project\_root\_directory', 'unit\_test\_commands', 'github\_repo\_url', 'dependency\_file\_location' Provide the suitable values respectively in tfvars for testing.
...
| <a name="module_codepipeline_terraform"></a> [codepipeline\_terraform](#module\_codepipeline\_terraform) | ../../modules/codepipeline_terraform | n/a |
...
| <a name="input_aws_org_id"></a> [aws\_org\_id](#input\_aws\_org\_id) | The AWS organization id that this pipeline instance is scoped to manage. | `string` | n/a | yes |
...
| <a name="input_cidr_ingress_rules_ec2"></a> [cidr\_ingress\_rules\_ec2](#input\_cidr\_ingress\_rules\_ec2) | n/a | <pre>list(object({<br>    from             = number<br>    to               = number<br>    protocol         = string<br>    cidr_blocks      = list(string)<br>    ipv6_cidr_blocks = list(string)<br>    description      = string<br>  }))</pre> | n/a | yes |
| <a name="input_codebuild_additional_policy"></a> [codebuild\_additional\_policy](#input\_codebuild\_additional\_policy) | Additional privies for the codebuild role. | `string` | n/a | yes |
...
| <a name="input_environment_type_codetest"></a> [environment\_type\_codetest](#input\_environment\_type\_codetest) | Type of build environment to use for codebuild project related builds. Valid values: LINUX\_CONTAINER, LINUX\_GPU\_CONTAINER, WINDOWS\_CONTAINER (deprecated), WINDOWS\_SER\_2019\_CONTAINER, ARM\_CONTAINER. | `string` | n/a | yes |
...
| <a name="input_python_runtime"></a> [python\_runtime](#input\_python\_runtime) | Enter the python version to compile application code - variable in buildspec yml | `string` | n/a | yes |
...
| <a name="input_s3_kms_key_arn"></a> [s3\_kms\_key\_arn](#input\_s3\_kms\_key\_arn) | KMS key arn for data encryption - a pre-requisite | `string` | n/a | yes |
...
| <a name="input_secretsmanager_ccoe_ssm_patch_pat"></a> [secretsmanager\_ccoe\_ssm\_patch\_pat](#input\_secretsmanager\_ccoe\_ssm\_patch\_pat) | secret manager path of the CCOE github OAUTH or PAT | `string` | n/a | yes |
...
| <a name="input_secretsmanager_terraform_token"></a> [secretsmanager\_terraform\_token](#input\_secretsmanager\_terraform\_token) | secret manager key for the terraform token value. | `string` | n/a | yes |
