...
aws_role    = "CloudAdmin"
aws_org_id  = "ou-nfqe-uk6yg06j" # PGE-Master-Dev/Nonprod/Dev
...
Notify             = ["tahv@pge.com", "j2tw@pge.com"] # Who to notify for system failure or maintenance. Should be a group or list of email addresses.
Owner              = ["tahv", "j2tw", "b1v6"]         # List three owners of the system, as defined by AMPS Director, Client Owner and IT Leader
...
#kms_key is a pre-requisite, coupled to a correct key policy.
