...
custom_domain_name = "ssukx.eks-java-acmtfc.nonprod.pge.com"
...
codepipeline_name = "petclinic-eks-ssukx"
github_org        = "pgetech"
...
container_name   = "spring-petclinic" // It should match the name in Chart.yaml; the repository image in values.yaml
namespace        = "java-app-ssukx"
