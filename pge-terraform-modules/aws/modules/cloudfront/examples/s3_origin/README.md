<!-- BEGIN_TF_DOCS -->
# AWS CloudFront module S3 Origin example
...
| <a name="module_cloudfront_oai"></a> [cloudfront\_oai](#module\_cloudfront\_oai) | ../../modules/origin_access_identity | n/a |
...
| <a name="module_s3_origin_bucket"></a> [s3\_origin\_bucket](#module\_s3\_origin\_bucket) | app.terraform.io/pgetech/s3/aws | 0.1.1 |
...
| <a name="input_origin_bucket_name"></a> [origin\_bucket\_name](#input\_origin\_bucket\_name) | Name of the S3 bucket for the origin | `string` | n/a | yes |
...
| <a name="input_s3_policy_origin"></a> [s3\_policy\_origin](#input\_s3\_policy\_origin) | Policy template file in json format | `string` | n/a | yes |
