...
#
#  Filename    : aws/modules/cloudfront/modules/cloudfront_s3_origin/main.tf
#  Date        : 22 april 2022
#  Author      : TCS
#  Description : CloudFront terraform module to create a CloudFront s3 origin.
#
...
# Module      : CloudFront s3 origin
# Description : This terraform module creates a cloudfront s3 origin.
