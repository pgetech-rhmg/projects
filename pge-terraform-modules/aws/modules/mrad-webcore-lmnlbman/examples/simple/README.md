...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lmnlbman"></a> [lmnlbman](#module\_lmnlbman) | ../../ | n/a |
...
| <a name="input_create_lmnlbman"></a> [create\_lmnlbman](#input\_create\_lmnlbman) | Whether to create a Lambda instance | `bool` | `false` | no |
