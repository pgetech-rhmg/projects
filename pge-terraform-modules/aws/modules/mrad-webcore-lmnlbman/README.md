# mrad-webcore-nlbman Lambda module

This module deploys the Engage-NLB-Manager Lambda from a given S3 bucket.
...
| <a name="module_lambda_logs"></a> [lambda\_logs](#module\_lambda\_logs) | app.terraform.io/pgetech/cloudwatch/aws//modules/log-group | 0.1.2 |
| <a name="module_nlbman_lambda"></a> [nlbman\_lambda](#module\_nlbman\_lambda) | app.terraform.io/pgetech/lambda/aws//modules/lambda_s3_bucket | 0.1.1 |
| <a name="module_nlbman_sumo"></a> [nlbman\_sumo](#module\_nlbman\_sumo) | app.terraform.io/pgetech/mrad-sumo/aws | 0.0.11 |

## Resources

| Name | Type |
|------|------|
| [aws_cloudwatch_event_rule.ssm_parameter_change](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_event_rule) | resource |
...
| [aws_cloudwatch_event_target.sns_notify](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_event_target) | resource |
...
| [aws_lambda_permission.allow_sns_invoke_engage_nlbman](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_permission) | resource |
...
| [aws_neptune_event_subscription.engage_neptune_events_sub](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/neptune_event_subscription) | resource |
| [aws_s3_object.lambda_zip](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_object) | resource |
| [aws_sns_topic.engage_neptune_events_topic](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sns_topic) | resource |
| [aws_sns_topic_subscription.engage_neptune_topic_nlblambda](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sns_topic_subscription) | resource |
