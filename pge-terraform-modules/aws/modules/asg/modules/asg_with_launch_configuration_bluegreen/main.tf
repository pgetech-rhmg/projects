...
resource "aws_autoscaling_group" "asg" {
  ...
  lifecycle {
    ...
    ignore_changes        = [load_balancers, target_group_arns] ## Ignoring the ALB Target-group changes occurred outside of TF code in case of ECS Bluegreen/Canary deployment
  }
