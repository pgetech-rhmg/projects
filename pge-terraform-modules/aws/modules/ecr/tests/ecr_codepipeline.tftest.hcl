run "ecr_codepipeline" {
  command = apply

  module {
    source = "./examples/ecr_codepipeline"
  }
}
...
variables {
  ...
  codepipeline_name                         = "spring-petclinic-bluegreen-a8t1"
  github_org                                = "pgetech"
  repo_name                                 = "pge-java-spring-petclinic"
  branch                                    = "e6bo-patch-1"
  project_name                              = "spring-petclinic-bluegreen-at81"
  project_key                               = "spring-petclinic-bluegreen-at81"
  ...
  environment_image_codesecret              = "aws/codebuild/amazonlinux2-x86_64-standard:4.0"
  ...
  kms_name                          = "codebuild_kms_key_a8t1"
  ...
  container_name                    = "spring-petclinic-at8"
