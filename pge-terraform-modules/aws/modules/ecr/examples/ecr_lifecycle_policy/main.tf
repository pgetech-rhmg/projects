...
*/
#
# Filename    : aws/modules/ecr/examples/ecr_lifecycle_policy/main.tf
# Date        : 17 february 2022
# Author      : TCS
# Description : ECR usage with lifecycle policy
...
module "ecr" {
  ...
  lifecycle_policy_enable = var.lifecycle_policy_enable
  lifecycle_policy        = file("${path.module}/${var.lifecycle_policy}")
  tags                    = merge(module.tags.tags, local.optional_tags)
}
