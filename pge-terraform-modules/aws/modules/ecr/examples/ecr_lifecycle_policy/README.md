...
| <a name="input_kms_name"></a> [kms\_name](#input\_kms\_name) | Unique name for creating cmk | `string` | n/a | yes |
| <a name="input_kms_role"></a> [kms\_role](#input\_kms\_role) | AWS role to administer the KMS key. | `string` | n/a | yes |
| <a name="input_lifecycle_policy"></a> [lifecycle\_policy](#input\_lifecycle\_policy) | The policy document for lifecycle policy. | `string` | n/a | yes |
| <a name="input_lifecycle_policy_enable"></a> [lifecycle\_policy\_enable](#input\_lifecycle\_policy\_enable) | Enable or disable lifecycle policy. | `bool` | n/a | yes |
