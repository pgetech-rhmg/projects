...
| Name | Type |
|------|------|
| [aws_appconfig_application.pge_app](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/appconfig_application) | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | The Application ARN generated by AWS |
| <a name="output_id"></a> [id](#output\_id) | The Application ID generated by AWS |
| <a name="output_tags"></a> [tags](#output\_tags) | All tags associated with the application. |
