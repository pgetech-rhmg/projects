...
| <a name="input_application_id"></a> [application\_id](#input\_application\_id) | An ID of an application to associate this environment with. | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | The AppCOnfig environment ARN |
| <a name="output_id"></a> [id](#output\_id) | The AppConfig environment ID |
