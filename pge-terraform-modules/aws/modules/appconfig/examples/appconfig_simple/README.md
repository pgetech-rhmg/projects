...
You may also reference the appconfig\_modular example for a full and modularized use case that allows
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_appconfig_simple"></a> [appconfig\_simple](#module\_appconfig\_simple) | ../../ | n/a |
...
| <a name="input_env_monitors"></a> [env\_monitors](#input\_env\_monitors) | A map of monitors for your deployment. | `set(any)` | `[]` | no |
| <a name="input_env_name"></a> [env\_name](#input\_env\_name) | The name of the AppConfig environment. | `string` | n/a | yes |
| <a name="input_hosted_config_content"></a> [hosted\_config\_content](#input\_hosted\_config\_content) | Content of the configuration or the configuration data | `string` | n/a | yes |
| <a name="input_hosted_config_content_type"></a> [hosted\_config\_content\_type](#input\_hosted\_config\_content\_type) | Standard MIME type describing the format of the configuration content | `string` | n/a | yes |
| <a name="input_hosted_config_description"></a> [hosted\_config\_description](#input\_hosted\_config\_description) | Description of the configuration. Forced new resource. | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_appconfig_outputs"></a> [appconfig\_outputs](#output\_appconfig\_outputs) | n/a |
