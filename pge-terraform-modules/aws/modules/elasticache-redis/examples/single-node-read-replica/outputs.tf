# Variables for aws_elasticache_replication_group

output "replication_group_arn" {
  value       = module.redis_single_node.replication_group_arn
  description = "ARN of the created ElastiCache Replication Group."
}

output "replication_group_engine_version_actual" {
  value       = module.redis_single_node.replication_group_engine_version_actual
  description = "Running version of the cache engine."
}

output "replication_group_cluster_enabled" {
  value       = module.redis_single_node.replication_group_cluster_enabled
  description = "Indicates if cluster mode is enabled."
}

output "replication_group_configuration_endpoint_address" {
  value       = module.redis_single_node.replication_group_configuration_endpoint_address
  description = "Address of the replication group configuration endpoint when cluster mode is enabled."
}

output "replication_group_id" {
  value       = module.redis_single_node.replication_group_id
  description = " ID of the ElastiCache Replication Group."
}

output "replication_group_member_clusters" {
  value       = module.redis_single_node.replication_group_member_clusters
...
output "replication_group_primary_endpoint_address" {
  value       = module.redis_single_node.replication_group_primary_endpoint_address
...
output "replication_group_reader_endpoint_address" {
  value       = module.redis_single_node.replication_group_reader_endpoint_address
...
output "replication_group_tags_all" {
  value       = module.redis_single_node.replication_group_tags_all
