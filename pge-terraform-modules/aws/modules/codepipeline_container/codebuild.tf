...
locals {
  codebuild_inline_policy = var.custom_codebuild_policy_file != null ? concat([file(var.custom_codebuild_policy_file)], [templatefile("${path.module}/modules/internal/codebuild_iam_policies/codebuild_wiz_iam_policy.json", {})]) : [templatefile("${path.module}/modules/internal/codebuild_iam_policies/codebuild_wizscan_iam_policy.json", {})]
...
module "codebuild_project" {
  ...
  codebuild_resource_policy = templatefile("${path.module}/modules/internal/codebuild_iam_policies/codebuild_inline_policy.json", {
