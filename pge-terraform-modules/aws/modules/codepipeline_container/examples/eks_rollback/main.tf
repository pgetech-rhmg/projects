...
*/
#
#  Filename    : aws/modules/codepipeline_container/examples/eks_rollback/main.tf
...
module "codepipeline" {
  ...
  compute_type_helmchart           = var.compute_type_argocd_deploy
  environment_type_helmchart       = var.environment_type_argocd_deploy
  environment_image_helmchart      = var.environment_image_argocd_deploy
  concurrent_build_limit_helmchart = var.concurrent_build_limit_argocd_deploy
  source_location_helmchart        = var.source_location_argocd_deploy
