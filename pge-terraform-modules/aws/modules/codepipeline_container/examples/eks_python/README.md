<!-- BEGIN_TF_DOCS -->
# AWS codepipeline example for python based Container application module example
...
| <a name="module_codepipeline"></a> [codepipeline](#module\_codepipeline) | ../../modules/eks_python | n/a |
