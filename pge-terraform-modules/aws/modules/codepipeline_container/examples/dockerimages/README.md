...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_codepipeline"></a> [codepipeline](#module\_codepipeline) | ../../../codepipeline_container | n/a |
...
| <a name="input_s3_bucket"></a> [s3\_bucket](#input\_s3\_bucket) | The name of the S3 bucket to be used | `string` | `""` | no |
...
| <a name="input_secretsmanager_wiz_client_id"></a> [secretsmanager\_wiz\_client\_id](#input\_secretsmanager\_wiz\_client\_id) | Enter the name of wiz client id stored in secrets manager | `string` | `"shared-wiz-access:WIZ_CLIENT_ID"` | no |
| <a name="input_secretsmanager_wiz_client_secret"></a> [secretsmanager\_wiz\_client\_secret](#input\_secretsmanager\_wiz\_client\_secret) | Enter the token of wiz client secret stored in secrets manager | `string` | `"shared-wiz-access:WIZ_CLIENT_SECRET"` | no |
