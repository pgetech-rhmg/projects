...
codepipeline_name = "ecs-java-stco"
github_org        = "pgetech"
repo_name         = "terraform-cicd-pipeline-ref"
branch            = "main"
project_name      = "spring-petclinic-bluegreen-stco"
project_key       = "spring-petclinic-bluegreen-stco"
...
project_root_directory = "reference-pipelines/java/ecs-eks/pge-java-spring-petclinic" #leave it empty if your source code is on root directory
...
#kms_key
kms_name        = "codebuild_kms_key_stco"
kms_description = "kms key for codebuild java"

#codeDeploy for BlueGreen Deployment
ecs_service_name              = "springapp-oxdi-test-new" # The codedeploy application name and deployment group name are based on the ecs service name.
