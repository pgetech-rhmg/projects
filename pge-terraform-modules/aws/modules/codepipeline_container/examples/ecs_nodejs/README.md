...
| <a name="module_codepipeline"></a> [codepipeline](#module\_codepipeline) | ../../modules/ecs_nodejs | n/a |
...
| <a name="input_container_name"></a> [container\_name](#input\_container\_name) | Enter the application name | `string` | `""` | no |
...
| <a name="input_deployment_timeout"></a> [deployment\_timeout](#input\_deployment\_timeout) | Please enter code deployment timeout | `number` | `30` | no |
| <a name="input_ecs_cluster_name"></a> [ecs\_cluster\_name](#input\_ecs\_cluster\_name) | Enter ECS Cluster name | `string` | `""` | no |
...
| <a name="input_node_runtime"></a> [node\_runtime](#input\_node\_runtime) | Enter the runtime version of node - variable in buildspec yml | `string` | n/a | yes |
