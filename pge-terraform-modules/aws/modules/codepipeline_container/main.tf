...
*/
#
#  Filename    : aws/modules/codepipeline/examples/codepipeline_dockerimages/main.tf
...
resource "aws_codepipeline" "codepipeline" {
  ...
  # Stage 2 Build, scan and publish docker image to Jfrog artifactory
  stage {
    name = "Build"
...
#Enabling notifications for Codepipeline build failures and success events
