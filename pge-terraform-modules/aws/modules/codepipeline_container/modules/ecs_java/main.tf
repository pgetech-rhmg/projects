...
*/
#
#  Filename    : aws/modules/codepipeline_container/modules/ecs_java/main.tf
#  Date        : 06 June 2024
#  Author      : PGE
#  Description : The terraform module creates a codepipeline for ECS Java
#
...
locals {
  ...
  artifactory_repo = coalesce(var.artifactory_maven_repo, var.artifactory_repo_name)
