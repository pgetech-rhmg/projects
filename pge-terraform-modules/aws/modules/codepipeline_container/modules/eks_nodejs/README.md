<!-- BEGIN_TF_DOCS -->
# AWS codepipeline EKS module for Nodejs
...
| <a name="input_artifactory_docker_repo"></a> [artifactory\_docker\_repo](#input\_artifactory\_docker\_repo) | Enter the name value of jfrog artifactory | `string` | `null` | no |
...
| <a name="input_artifactory_nodejs_repo"></a> [artifactory\_nodejs\_repo](#input\_artifactory\_nodejs\_repo) | Enter the name value of jfrog artifactory | `string` | `null` | no |
...
| <a name="input_build_command"></a> [build\_command](#input\_build\_command) | Build or install command for nodejs webapp | `string` | `null` | no |
...
| <a name="input_is_eks_fargate"></a> [is\_eks\_fargate](#input\_is\_eks\_fargate) | To embed Twistlock defender if the cluster is EKS Fargate | `bool` | `true` | no |
...
| <a name="input_node_build"></a> [node\_build](#input\_node\_build) | Build or install command for nodejs webapp | `string` | `null` | no |
| <a name="input_node_runtime"></a> [node\_runtime](#input\_node\_runtime) | Enter the nodejs runtime version for codebuild stages - variable in buildspec yml | `string` | `null` | no |
| <a name="input_nodejs_runtime"></a> [nodejs\_runtime](#input\_nodejs\_runtime) | Enter the runtime version of node - variable in buildspec yml | `string` | `null` | no |
