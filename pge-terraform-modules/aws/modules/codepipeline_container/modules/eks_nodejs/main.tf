...
*/
#
#  Filename    : aws/modules/codepipeline_container/modules/eks_nodejs/main.tf
#  Date        : 12/31/2024
#  Author      : PGE
#  Description : The terraform module creates a codepipeline for EKS Nodejs
#
...
locals {
  ...
  runtime          = coalesce(var.node_runtime, var.nodejs_runtime)
