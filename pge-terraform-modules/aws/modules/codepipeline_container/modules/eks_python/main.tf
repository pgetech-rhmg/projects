...
*/
#
#  Filename    : aws/modules/codepipeline_container/modules/eks_python/main.tf
#  Date        : 12/31/2024
#  Author      : PGE
#  Description : The terraform module creates a codepipeline for EKS Python
#
...
locals {
  ...
  artifactory_repo = coalesce(var.artifactory_python_repo, var.artifactory_repo_name)
...
module "internal_container" {
  ...
  artifactory_helm_local_repo             = var.artifactory_helm_local_repo
