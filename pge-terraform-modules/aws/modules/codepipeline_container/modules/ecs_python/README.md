<!-- BEGIN_TF_DOCS -->
# AWS codepipeline ECS module for python
...
| <a name="input_artifactory_python_repo"></a> [artifactory\_python\_repo](#input\_artifactory\_python\_repo) | Enter the name value of JFrog Artifactory | `string` | `null` | no |
...
| <a name="input_aws_account_number"></a> [aws\_account\_number](#input\_aws\_account\_number) | Enter the provisioned account number | `string` | n/a | yes |
