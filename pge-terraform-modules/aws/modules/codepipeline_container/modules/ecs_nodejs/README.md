...
| <a name="input_is_eks_fargate"></a> [is\_eks\_fargate](#input\_is\_eks\_fargate) | To embed wiz defender if the cluster is EKS Fargate | `bool` | `false` | no |
...
| <a name="input_node_runtime"></a> [node\_runtime](#input\_node\_runtime) | Enter the runtime version of node - variable in buildspec yml | `string` | `"16"` | no |
...
| <a name="input_runtime_version"></a> [runtime\_version](#input\_runtime\_version) | Enter the runtime version of node - variable in buildspec yml | `string` | `null` | no |
