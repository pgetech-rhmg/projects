<!-- BEGIN_TF_DOCS -->
# AWS DocumentDB Cluster snapshot with event notification User module example
...
| <a name="module_docdb_cluster_snapshot"></a> [docdb\_cluster\_snapshot](#module\_docdb\_cluster\_snapshot) | ../../modules/cluster_snapshot | n/a |
...
| <a name="output_event_subscription_arn"></a> [event\_subscription\_arn](#output\_event\_subscription\_arn) | The Amazon Resource Name of the DocDB event notification subscription. |
| <a name="output_event_subscription_customer_aws_id"></a> [event\_subscription\_customer\_aws\_id](#output\_event\_subscription\_customer\_aws\_id) | The AWS customer account associated with the DocDB event notification subscription. |
| <a name="output_event_subscription_id"></a> [event\_subscription\_id](#output\_event\_subscription\_id) | The name of the DocDB event notification subscription. |
