...
*/
#
#  Filename    : aws/modules/documentdb/examples/cluster_snapshot_with_event_notification/main.tf
#  Date        : 05 August 2022
#  Author      : TCS
#  Description : The terraform example creates a cluster snapshot with event notification
...
module "docdb_cluster_snapshot" {
  source = "../../modules/cluster_snapshot"

  db_cluster_identifier          = module.docdb_cluster.docdb_cluster_id
  db_cluster_snapshot_identifier = local.name
}
