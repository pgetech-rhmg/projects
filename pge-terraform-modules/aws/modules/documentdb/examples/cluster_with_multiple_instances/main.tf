/*
 * # AWS DocumentDB Cluster with multiple instances User module example
*/
#
#  Filename    : aws/modules/documentdb/examples/cluster_with_multiple_instances/main.tf
#  Date        : 05 August 2022
#  Author      : TCS
#  Description : The terraform example creates a cluster with multiple instances
