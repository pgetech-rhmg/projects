...
*/
#
#  Filename    : aws/modules/Neptune/examples/cluster_single_instance/main.tf
#  Date        : 12 July 2022
#  Author      : TCS

#  Description : The terraform example creates a cluster with single instance, subnet_group, cluster parameter group and instance parameter group
