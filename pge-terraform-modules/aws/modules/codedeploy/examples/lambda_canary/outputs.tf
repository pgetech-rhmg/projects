output "codedeploy_app_arn" {
  value       = module.codedeploy_app_lambda.codedeploy_app_arn
  description = "The ARN of the CodeDeploy application."
}

output "codedeploy_app_application_id" {
  value       = module.codedeploy_app_lambda.codedeploy_app_application_id
  description = "The application ID."
}

output "codedeploy_app_id" {
  value       = module.codedeploy_app_lambda.codedeploy_app_id
  description = "Amazon's assigned ID for the application."
}

output "codedeploy_app_name" {
  value       = module.codedeploy_app_lambda.codedeploy_app_name
  description = "The application's name."
}

output "codedeploy_app_github_account_name" {
  value       = module.codedeploy_app_lambda.codedeploy_app_github_account_name
  description = "The name for a connection to a GitHub account."
}

output "codedeploy_app_linked_to_github" {
  value       = module.codedeploy_app_lambda.codedeploy_app_linked_to_github
  description = "Whether the user has authenticated with GitHub for the specified application."
}

output "codedeploy_app_tags_all" {
  value       = module.codedeploy_app_lambda.codedeploy_app_tags_all
  description = "A map of tags assigned to the resource."
}

#outputs for deployment_config_lambda
output "deployment_group_config_name" {
  value       = module.deployment_config_lambda.deployment_group_config_name
  description = "The deployment group's config name."
}

output "deployment_config_id" {
  value       = module.deployment_config_lambda.deployment_config_id
