<!-- BEGIN_TF_DOCS -->
# AWS Lambda event source mapping using Rabbit MQ
...
| Name | Type |
|------|------|
| [aws_lambda_event_source_mapping.rabbit_mq_event_source_mapping](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_event_source_mapping) | resource |
...
| <a name="input_queues"></a> [queues](#input\_queues) | The name of the Amazon MQ broker destination queue to consume. | `list(string)` | n/a | yes |
