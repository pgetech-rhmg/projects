...
*/
#
#  Filename    : aws/modules/lambda/modules/event_source_mapping_kinesis/main.tf
#  Date        : 24 January 2022
#  Author      : TCS
#  Description : LAMBDA terraform module creates a Lambda event source mapping using kinesis 
#
