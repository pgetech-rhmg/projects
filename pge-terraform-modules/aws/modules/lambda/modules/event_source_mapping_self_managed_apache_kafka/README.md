...
| Name | Type |
|------|------|
| [aws_lambda_event_source_mapping.kafka_event_source_mapping](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_event_source_mapping) | resource |
...
| <a name="input_self_managed_event_source_endpoints"></a> [self\_managed\_event\_source\_endpoints](#input\_self\_managed\_event\_source\_endpoints) | A map of endpoints for the self managed source.The key should be KAFKA\_BOOTSTRAP\_SERVERS and the value should be a string with a comma separated list of broker endpoints. | `map(string)` | n/a | yes |
