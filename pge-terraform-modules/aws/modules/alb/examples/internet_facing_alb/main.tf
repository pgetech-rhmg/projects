 ...
 * Public ALB tetsing is not done as there is no public subnet available in the aws account.
*/
#
# Filename    : aws/modules/alb/examples/internet_facing_alb/main.tf
# Date        : 22 March 2022
# Author      : TCS
# Description : ALB creation main for internet facing.
#
...
module "alb" {
  source = "../../modules/internet_facing_alb"
