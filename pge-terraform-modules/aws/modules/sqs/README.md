...
| <a name="input_kms_key_id"></a> [kms\_key\_id](#input\_kms\_key\_id) | The ID of an AWS-managed customer master key (CMK) for Amazon SQS or a custom CMK | `string` | `null` | no |
...
| <a name="input_sqs_name"></a> [sqs\_name](#input\_sqs\_name) | The SQS queue name for fifo queue | `string` | n/a | yes |
