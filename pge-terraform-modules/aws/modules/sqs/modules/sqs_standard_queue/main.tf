...
#  Filename    : aws/modules/sqs/modules/sqs_standard_queue/main.tf
#  Date        : 02 February 2021
#  Author      : TCS
#  Description : Terraform module for creation of sqs standard queue
#
...
# Module      : sqs topic
# Description : This terraform module creates an encrypted sqs 
