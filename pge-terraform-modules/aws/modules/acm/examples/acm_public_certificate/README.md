...
This example will handle the record creation in Route53 if acm\_r53update\_validate is set to true. By default, it will launch into public zone of r53 account.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_acm_public_certificate"></a> [acm\_public\_certificate](#module\_acm\_public\_certificate) | ../../ | n/a |
...
| <a name="input_account_num_r53"></a> [account\_num\_r53](#input\_account\_num\_r53) | Target route53 AWS account number, mandatory | `string` | `"514712703977"` | no |
...
| <a name="input_aws_r53_role"></a> [aws\_r53\_role](#input\_aws\_r53\_role) | AWS role to assume to work with r53 account\_number | `string` | `"CloudAdmin"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_acm_certificate"></a> [acm\_certificate](#output\_acm\_certificate) | The ARN of the certificate |
