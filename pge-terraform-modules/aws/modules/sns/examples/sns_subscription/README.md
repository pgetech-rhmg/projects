<!-- BEGIN_TF_DOCS -->
# AWS SNS module with subscription example
...
| <a name="module_sns_topic_subscription"></a> [sns\_topic\_subscription](#module\_sns\_topic\_subscription) | ../../modules/sns_subscription | n/a |
