...
| <a name="module_asg"></a> [asg](#module\_asg) | app.terraform.io/pgetech/asg/aws | 0.1.3 |
...
| <a name="module_lambda_s3_bucket"></a> [lambda\_s3\_bucket](#module\_lambda\_s3\_bucket) | app.terraform.io/pgetech/lambda/aws//modules/lambda_s3_bucket | 0.1.3 |
...
| <a name="input_autoscaling_policy_name"></a> [autoscaling\_policy\_name](#input\_autoscaling\_policy\_name) | n/a | `string` | `"nonbg-scale-a"` | no |
| <a name="input_bluegreen_iam_role_name"></a> [bluegreen\_iam\_role\_name](#input\_bluegreen\_iam\_role\_name) | IAM role name for Blue-Green AMI automation | `string` | `"ami_nonbg_testing"` | no |
...
| <a name="input_bluegreen_instance_profile_name"></a> [bluegreen\_instance\_profile\_name](#input\_bluegreen\_instance\_profile\_name) | IAM instance profile name used by blue/green ASGs | `string` | `"instance_profile"` | no |
...
| <a name="input_launch_template_name"></a> [launch\_template\_name](#input\_launch\_template\_name) | n/a | `string` | `"nonbg-lt-a"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_alb_arn"></a> [alb\_arn](#output\_alb\_arn) | ALB |
...
| <a name="output_asg_name"></a> [asg\_name](#output\_asg\_name) | ASG |
| <a name="output_lambda_arn"></a> [lambda\_arn](#output\_lambda\_arn) | n/a |
| <a name="output_latest_ami_parameter_name"></a> [latest\_ami\_parameter\_name](#output\_latest\_ami\_parameter\_name) | SSM |
