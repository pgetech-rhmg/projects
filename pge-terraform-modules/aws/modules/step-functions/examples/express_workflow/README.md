<!-- BEGIN_TF_DOCS -->
# AWS Step Functions Express Workflow Example
...
| <a name="module_express_workflow"></a> [express\_workflow](#module\_express\_workflow) | ../.. | n/a |
...
| <a name="input_state_machine_type"></a> [state\_machine\_type](#input\_state\_machine\_type) | Determines whether a Standard or Express state machine is created. The default is STANDARD. | `string` | n/a | yes |
