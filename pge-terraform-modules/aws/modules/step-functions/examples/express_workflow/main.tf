...
*/
#
#  Filename    : aws/modules/step-functions/examples/express_workflow/main.tf
#  Date        : 17 Oct 2022
#  Author      : TCS
#  Description : The terraform example creates a step-functions express workflow
...
#Provides a Step Function State Machine with Express workflow
module "express_workflow" {
  source = "../.."

  state_machine_type            = var.state_machine_type
