...
#variable for lambda_orchestration
...
variable "lambda_check_stock_price_name" {
  description = "Unique name for your Lambda Function for check_stock_price."
  type        = string
}

variable "lambda_check_stock_price_directory" {
  description = "Package entire contents of this directory into the archive."
  type        = string
}

variable "lambda_generate_buy_sell_recommendation_name" {
  description = "Unique name for your Lambda Function for generate_buy_sell_recommendation."
  type        = string
}

variable "lambda_generate_buy_sell_recommendation_directory" {
  description = "Package entire contents of this directory into the archive."
  type        = string
}

variable "lambda_approve_sqs_name" {
  description = "Unique name for your Lambda Function for approve_sqs."
  type        = string
}

variable "lambda_approve_sqs_directory" {
  description = "Package entire contents of this directory into the archive."
  type        = string
}

variable "lambda_buy_stock_name" {
  description = "Unique name for your Lambda Function for buy_stock."
  type        = string
}

variable "lambda_buy_stock_directory" {
  description = "Package entire contents of this directory into the archive."
  type        = string
}

variable "lambda_sell_stock_name" {
  description = "Unique name for your Lambda Function for sell_stock."
  type        = string
}

variable "lambda_sell_stock_directory" {
  description = "Package entire contents of this directory into the archive."
  type        = string
}
