...
| <a name="input_aws_region"></a> [aws\_region](#input\_aws\_region) | Region to create resources in. | `string` | n/a | yes |
...
| <a name="input_secret_string"></a> [secret\_string](#input\_secret\_string) | Accepts secret string key-value pairs | `map(string)` | n/a | yes |
