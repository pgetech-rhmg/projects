...
| <a name="input_jfrog_host"></a> [jfrog\_host](#input\_jfrog\_host) | Jfrog artifactory host name. | `string` | n/a | yes |
...
| <a name="input_secret_string"></a> [secret\_string](#input\_secret\_string) | Specifies text data that you want to encrypt and store in this version of the secret | `any` | n/a | yes |
