<!-- BEGIN_TF_DOCS -->
# AWS codepipeline module for Python
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_internal_core"></a> [internal\_core](#module\_internal\_core) | ./modules/internal/ | n/a |
...
| <a name="input_s3_bucket_name"></a> [s3\_bucket\_name](#input\_s3\_bucket\_name) | S3 bucket name to download packages to install telerik | `string` | `null` | no |
