...
# Prerequisites : In the variable 'ssm\_parameter\_github\_oauth\_token', 'github\_repo\_url', 'project\_name', 'project\_root\_directory','nodejs\_version` Provide the suitable values respectively for testing.
...
| <a name="module_codepipeline"></a> [codepipeline](#module\_codepipeline) | ../../modules/nodejs | n/a |
...
| <a name="module_security_group_EC2"></a> [security\_group\_EC2](#module\_security\_group\_EC2) | app.terraform.io/pgetech/security-group/aws | 0.1.0 |
...
| <a name="input_ssm_parameter_artifactory_repo_name"></a> [ssm\_parameter\_artifactory\_repo\_name](#input\_ssm\_parameter\_artifactory\_repo\_name) | Enter JFrog npm Artifactory repo name to use in Terraform CodePipeline to pull the npm dependencies | `string` | n/a | yes |
...
| <a name="input_unit_test_commands"></a> [unit\_test\_commands](#input\_unit\_test\_commands) | Enter the unit test commands for python webapp | `string` | `"npm run test"` | no | 
