...
*/
#
#  Filename    : aws/modules/codepipeline_core/examples/nodejs/main.tf
...
module "codepipeline" {
  ...
  artifact_name_nodejs   = var.artifact_name_nodejs ## unused variable in the module, it will be removed in the next version.
