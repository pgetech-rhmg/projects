...
module "codepipeline" {
  ...
  project_unit_test_dir  = var.project_unit_test_dir ## unused variable in the module, it will be removed in the next version.
  project_file_location  = var.project_file_location ## unused variable in the module, it will be removed in the next version.
  # #artifact_name_dotnet   = var.artifact_name_dotnet
  artifact_version   = var.artifact_version ## unused variable in the module, it will be removed in the next version.
