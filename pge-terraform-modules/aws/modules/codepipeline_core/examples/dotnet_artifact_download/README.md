...
| <a name="input_artifact_version"></a> [artifact\_version](#input\_artifact\_version) | Enter the artifact version | `string` | n/a | yes |
...
| <a name="input_project_file_location"></a> [project\_file\_location](#input\_project\_file\_location) | Enter the project file location value | `string` | n/a | yes |
