...
variables {
  ...
  codepipeline_name                       = "codepipeline-nodejs-r5vd"
  github_org                              = "pgetech"
  ...
  codetest_role_name                      = "codetest_nodejs_iam_policy_stco"
  ...
  sg_name                                 = "codebuild_project_nodejs_1121"
  ...
  sg_name_ec2        = "ec2-sg-nodejs-stco"
  ...
  codedeploy_app_name           = "codepipeline-nodejs-stco"
