...
#  Date        : 04 Oct 2024
#  Author      : PGE
#  Description : The terraform module creates a codepipeline for nodejs application
...
locals {
  ...
  node_runtime          = var.node_runtime != "" ? var.node_runtime : var.nodejs_version
...
module "internal_core" {
  ...
  node_runtime                            = local.node_runtime
