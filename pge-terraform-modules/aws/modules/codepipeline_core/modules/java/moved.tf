...
moved {
  from = module.codebuild_codepublish[0].aws_codebuild_project.codebuild_project
  to   = module.internal_core.module.codebuild_codepublish[0].aws_codebuild_project.codebuild_project
}

moved {
  from = module.codebuild_codepublish[0].aws_codebuild_resource_policy.codebuild_resource_policy
  to   = module.internal_core.module.codebuild_codepublish[0].aws_codebuild_resource_policy.codebuild_resource_policy
}

moved {
  from = module.codebuild_codepublish[0].aws_codebuild_source_credential.codebuild_source_credential
  to   = module.internal_core.module.codebuild_codepublish[0].aws_codebuild_source_credential.codebuild_source_credential
}

moved {
  from = module.codebuild_codescan[0].aws_codebuild_project.codebuild_project
  to   = module.internal_core.module.codebuild_codescan[0].aws_codebuild_project.codebuild_project
}

moved {
  from = module.codebuild_codescan[0].aws_codebuild_resource_policy.codebuild_resource_policy
  to   = module.internal_core.module.codebuild_codescan[0].aws_codebuild_resource_policy.codebuild_resource_policy
}

moved {
  from = module.codebuild_iam_role[0].aws_iam_role_policy.role_policy[1]
  to   = module.internal_core.module.codebuild_iam_role.aws_iam_role_policy.role_policy[1]
}

moved {
  from = module.codebuild_project[0].aws_codebuild_project.codebuild_project
  to   = module.internal_core.module.codebuild_project[0].aws_codebuild_project.codebuild_project
}

moved {
  from = module.codebuild_project[0].aws_codebuild_resource_policy.codebuild_resource_policy
  to   = module.internal_core.module.codebuild_project[0].aws_codebuild_resource_policy.codebuild_resource_policy
}

moved {
  from = module.codebuild_project[0].aws_codebuild_source_credential.codebuild_source_credential
  to   = module.internal_core.module.codebuild_project[0].aws_codebuild_source_credential.codebuild_source_credential
}

moved {
  from = module.codepublish_iam_role[0].aws_iam_role.default
  to   = module.codepublish_iam_role.aws_iam_role.default
}

moved {
  from = module.codepublish_iam_role[0].aws_iam_role_policy.role_policy[0]
  to   = module.internal_core.module.codepublish_iam_role.aws_iam_role_policy.role_policy[0]
}

moved {
  from = module.codepublish_iam_role[0].aws_iam_role_policy.role_policy[1]
  to   = module.internal_core.module.codepublish_iam_role.aws_iam_role_policy.role_policy[1]
}

moved {
  from = module.codebuild_iam_role[0].aws_iam_role.default
  to   = module.internal_core.module.codebuild_iam_role.aws_iam_role.default
}

moved {
  from = module.codebuild_iam_role[0].aws_iam_role_policy.role_policy[0]
