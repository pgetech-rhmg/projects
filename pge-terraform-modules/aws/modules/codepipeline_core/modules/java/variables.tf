...
variable "encryption_key_id" {
  description = "The KMS key ARN or ID for codepipeline artifact store"
  type        = string
  default     = null
}
...
variable "dependency_file_location" {
  description = "Enter the location of dependency file - variable in buildspec yml"
  type        = string
}
