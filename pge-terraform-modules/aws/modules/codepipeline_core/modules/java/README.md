...
| <a name="input_java_runtime"></a> [java\_runtime](#input\_java\_runtime) | Enter the java runtime version for build satges - variable in buildspec yml | `string` | `"corretto17"` | no |
...
| <a name="input_unit_test_commands"></a> [unit\_test\_commands](#input\_unit\_test\_commands) | Enter the unit test commands for python webapp | `string` | `""` | no |
