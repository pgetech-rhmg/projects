...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_glue_workflow"></a> [glue\_workflow](#module\_glue\_workflow) | ../../../glue/modules/glue_workflow | n/a |
...
| <a name="input_glue_workflow_default_run_properties"></a> [glue\_workflow\_default\_run\_properties](#input\_glue\_workflow\_default\_run\_properties) | A map of default run properties for this workflow. These properties are passed to all jobs associated to the workflow. | `map(string)` | n/a | yes |
| <a name="input_glue_workflow_max_concurrent_runs"></a> [glue\_workflow\_max\_concurrent\_runs](#input\_glue\_workflow\_max\_concurrent\_runs) | Prevents exceeding the maximum number of concurrent runs of any of the component jobs. If you leave this parameter blank, there is no limit to the number of concurrent workflow runs. | `number` | n/a | yes |
| <a name="input_name"></a> [name](#input\_name) | name of the workflow | `string` | n/a | yes |
