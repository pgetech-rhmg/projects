...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lmgisseed"></a> [lmgisseed](#module\_lmgisseed) | ../../ | n/a |
...
| <a name="input_create_lmgisseed"></a> [create\_lmgisseed](#input\_create\_lmgisseed) | Whether to create a Lambda instance | `bool` | `false` | no |
