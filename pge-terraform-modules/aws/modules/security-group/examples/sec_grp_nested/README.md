...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_nested_security_group"></a> [nested\_security\_group](#module\_nested\_security\_group) | ../../ | n/a |
...
| <a name="input_description"></a> [description](#input\_description) | The description of the security group | `string` | `"nested_cloud-coe-sg"` | no |
| <a name="input_nested_name"></a> [nested\_name](#input\_nested\_name) | Unique name for the nested security group | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_nested_security_group_id"></a> [nested\_security\_group\_id](#output\_nested\_security\_group\_id) | security group id |
| <a name="output_nested_security_group_name"></a> [nested\_security\_group\_name](#output\_nested\_security\_group\_name) | security group name |
