...
| <a name="module_image_iam_role"></a> [image\_iam\_role](#module\_image\_iam\_role) | app.terraform.io/pgetech/iam/aws | 0.1.1 |
...
| <a name="input_name"></a> [name](#input\_name) | The name of the Studio Lifecycle Configuration to create. | `string` | n/a | yes |
