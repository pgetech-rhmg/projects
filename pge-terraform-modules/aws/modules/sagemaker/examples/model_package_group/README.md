<!-- BEGIN_TF_DOCS -->
# AWS Sagemaker model\_package\_group example
# Terraform module example usage for Sagemaker model\_package\_group
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_model_package_group"></a> [model\_package\_group](#module\_model\_package\_group) | ../../modules/model_package_group | n/a |
...
| <a name="input_name"></a> [name](#input\_name) | The name of the model group. | `string` | n/a | yes |
