/*
 * # AWS Sagemaker endpoint_configuration provisioned
 * # Terraform module which creates Sagemaker endpoint_configuration_provisioned
*/
#
#  Filename    : aws/modules/sagemaker/examples/endpoint_config_provisioned/main.tf
#  Date        : Sept 7 2022
#  Author      : TCS
#  Description : The terraform module creates a sagemaker endpoint_configuration_provisioned for Sagemaker
