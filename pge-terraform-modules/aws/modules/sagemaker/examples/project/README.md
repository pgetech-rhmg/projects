...
| <a name="input_product_id"></a> [product\_id](#input\_product\_id) | The ID of the product to provision. | `string` | n/a | yes |
| <a name="input_provisioning_artifact_id"></a> [provisioning\_artifact\_id](#input\_provisioning\_artifact\_id) | The ID of the provisioning artifact. | `string` | n/a | yes | 
