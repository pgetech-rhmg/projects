...
| [aws_backup_vault_lock_configuration.vault_lock_configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/backup_vault_lock_configuration) | resource |
...
| <a name="input_enable_vault_lock"></a> [enable\_vault\_lock](#input\_enable\_vault\_lock) | Change to true to add a lock configuration for the backup vault | `bool` | `false` | no |
