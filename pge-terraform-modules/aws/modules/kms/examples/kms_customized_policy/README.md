...
| <a name="input_name"></a> [name](#input\_name) | The display name of the alias. The module would append the word `alias` followed by a forward slash with the variable value. | `string` | n/a | yes |
...
| <a name="output_key_id"></a> [key\_id](#output\_key\_id) | KMS ID |
