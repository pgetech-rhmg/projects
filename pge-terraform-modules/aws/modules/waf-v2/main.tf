...
#
#  Filename    : aws/modules/waf-v2/main.tf
#  Date        : 2 February 2022
#  Author      : TCS
#  Description : Terraform module to create a waf v2 web acl cloudfront.
#
...
# Module      : WAF Web ACL
# Description : This terraform module creates a waf web acl cloudfront.
...
resource "aws_wafv2_web_acl" "wafv2-web-acl" {
  ...
  # AWS Managed Rules
  # The 'rule' optional block, can iterate multiple times if multiple values are passed for the variable "managed_rules".
  dynamic "rule" {
        ...
        dynamic "allow" {
          ...
          content {
            dynamic "custom_request_handling" {
              for_each = lookup(rule.value, "custom_request_handling", null) != null ? (length(lookup(rule.value, "custom_request_handling", [])) == 0 ? [] : lookup(rule.value, "custom_request_handling", [])) : []
              content {
