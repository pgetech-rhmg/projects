/*
 * # AWS WAF IP Set Cloudfront module example
*/
#
# Filename    : aws/modules/waf-v2/examples/waf_v2_ipset_cloudfront/main.tf
# Date        : 7 March 2022
# Author      : TCS
# Description : WAF Ip Set Cloudfront usage creation main.
#
