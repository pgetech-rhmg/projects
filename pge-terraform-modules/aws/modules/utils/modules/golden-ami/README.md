...
|------|-------------|------|---------|:--------:|
| <a name="input_os"></a> [os](#input\_os) | operating system type | `string` | `"linux"` | no |
| <a name="input_parameter"></a> [parameter](#input\_parameter) | Parameter store location to read | `string` | `null` | no |
