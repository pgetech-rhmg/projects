/*
 * # AWS Lambda@edge module with Cloudfront distribution example. This example is using Cloudfront terraform resource.
 * # Code verified using terraform validate and terraform fmt -check.
*/
#
#  Filename    : aws/modules/lambda-at-edge/modules/lambda_local/main.tf
#  Date        : 20 September 2022
#  Author      : PGE
#  Description : creation of cloudfront distribution using TF resource and lambda@edge module
#
