...
| <a name="module_lambda_layer"></a> [lambda\_layer](#module\_lambda\_layer) | app.terraform.io/pgetech/lambda/aws//modules/lambda_layer_version_s3 | 0.1.3 |
...
| <a name="module_rotation_lambda_function"></a> [rotation\_lambda\_function](#module\_rotation\_lambda\_function) | app.terraform.io/pgetech/lambda/aws | 0.1.3 |
| <a name="module_rotation_lambda_iam_role"></a> [rotation\_lambda\_iam\_role](#module\_rotation\_lambda\_iam\_role) | app.terraform.io/pgetech/iam/aws | 0.1.1 |
| <a name="module_secrets_manager"></a> [secrets\_manager](#module\_secrets\_manager) | app.terraform.io/pgetech/secretsmanager/aws | 0.1.3 |
...
| [aws_lambda_permission.allow_sm_invoke](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_permission) | resource |
...
| <a name="input_domain_iam_role_name"></a> [domain\_iam\_role\_name](#input\_domain\_iam\_role\_name) | The name of the IAM role to be used when making API calls to the Directory Service | `string` | n/a | yes |
...
| <a name="input_sm_rotation_policy"></a> [sm\_rotation\_policy](#input\_sm\_rotation\_policy) | Valid JSON document representing a resource policy for the rotation lambda function | `string` | `null` | no |
...
| <a name="input_source_dir"></a> [source\_dir](#input\_source\_dir) | Package entire contents of this directory into the archive. | `string` | `null` | no |
...
| <a name="output_aws_lambda_permission"></a> [aws\_lambda\_permission](#output\_aws\_lambda\_permission) | Map of aws\_lambda\_permission object |
...
| <a name="output_oracle_all"></a> [oracle\_all](#output\_oracle\_all) | A list of map of oracle module |
