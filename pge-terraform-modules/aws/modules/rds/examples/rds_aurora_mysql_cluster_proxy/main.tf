...
*/
#
#  Filename    : modules/rds/examples/rds_aurora_mysql_cluster_proxy/main.tf
#  Date        : 3/25/2024
#  Author      : PGE 
#  Description : Example of AWS Aurora mysql cluster proxy module
#
terraform {
...
module "rds_proxy" {
  ...
  auth = {
    "root" = {
      ...
      secret_arn = var.manage_master_user_password ? module.aurora-mysql.cluster_master_user_secret[0].secret_arn : var.secretsmanager_arn
    }
  }
  ...
  db_cluster_identifier = module.aurora-mysql.db_cluster_id
  tags                  = var.tags
}
