<!-- BEGIN_TF_DOCS -->
# RDS Aurora mysql proxy module
Terraform module which creates an RDS Aurora mysql Database proxy.
Pre-Requisites:
...
Notes:
  ...
  3. This module includes logic to pass in private subnets and vpc(/vpc/2/privatesubnet1/id, /vpc/2/privatesubnet2/id,
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aurora-mysql"></a> [aurora-mysql](#module\_aurora-mysql) | ../../modules/aurora-mysql | n/a |
...
| <a name="module_rds_proxy"></a> [rds\_proxy](#module\_rds\_proxy) | ../../modules/rds_proxy | n/a |
...
| <a name="input_secretsmanager_arn"></a> [secretsmanager\_arn](#input\_secretsmanager\_arn) | secretsmanager arn | `any` | `""` | no |
...
| <a name="output_rds_proxy_sg"></a> [rds\_proxy\_sg](#output\_rds\_proxy\_sg) | A map of security group created for rds proxy |
