...
output "db_cluster_master_user_secret" {
  ...
  value       = one(module.aurora-mysql[*].aurora-mysql-all[0].aws_rds_cluster_all.master_user_secret[0].secret_arn)
}
output "db_cluster_id" {
  description = "The RDS Cluster Identifier."
  value       = module.aurora-mysql.db_cluster_id
}
...
output "db_cluster_cluster_identifier" {
  description = "The RDS Cluster Identifier."
  value       = module.aurora-mysql.db_cluster_cluster_identifier
}
output "db_cluster_cluster_resource_id" {
  description = "The RDS Cluster Resource ID."
  value       = module.aurora-mysql.db_cluster_cluster_resource_id
}
output "db_cluster_cluster_members" {
  description = "List of RDS Instances that are a part of this cluster."
  value       = module.aurora-mysql.db_cluster_cluster_members
}
output "db_cluster_availability_zones" {
  description = "The availability zone of the instance."
  value       = module.aurora-mysql.db_cluster_availability_zones
}
output "db_cluster_backup_retention_period" {
  description = "The backup retention period."
  value       = module.aurora-mysql.db_cluster_backup_retention_period
}
output "db_cluster_preferred_backup_window" {
  description = "The daily time range during which the backups happen."
  value       = module.aurora-mysql.db_cluster_preferred_backup_window
}
output "db_cluster_preferred_maintenance_window" {
  description = "The maintenance window."
  value       = module.aurora-mysql.db_cluster_preferred_maintenance_window
}
...
output "db_cluster_engine" {
  ...
  value       = module.aurora-mysql.db_cluster_engine
}
output "db_cluster_engine_version_actual" {
  description = "The running version of the database."
  value       = module.aurora-mysql.db_cluster_engine_version_actual
}
output "db_cluster_database_name" {
  description = "The database name."
  value       = module.aurora-mysql.db_cluster_database_name
}
output "db_cluster_port" {
  description = "The database port."
  value       = module.aurora-mysql.db_cluster_port
}
output "db_cluster_master_username" {
  description = "The master username for the database."
  value       = module.aurora-mysql.db_cluster_master_username
}
output "db_cluster_storage_encrypted" {
  description = "Specifies whether the DB cluster is encrypted."
  value       = module.aurora-mysql.db_cluster_storage_encrypted
}
output "db_cluster_replication_source_identifier" {
  ...
  value       = module.aurora-mysql.db_cluster_replication_source_identifier
}
output "db_cluster_hosted_zone_id" {
  description = "The Route53 Hosted Zone ID of the endpoint."
  value       = module.aurora-mysql.db_cluster_hosted_zone_id
}
output "db_cluster_tags_all" {
  description = "A map of tags assigned to the resource, including those inherited from the provider default_tags configuration block.."
  value       = module.aurora-mysql.db_cluster_tags_all
}

#db_cluster_instance
output "db_cluster_instance_arn" {
  description = "Amazon Resource Name (ARN) of cluster instance."
  value       = module.aurora-mysql.db_cluster_instance_arn
}
output "db_cluster_instance_cluster_identifier" {
  description = "The RDS Cluster Identifier."
  value       = module.aurora-mysql.db_cluster_instance_cluster_identifier
}
output "db_cluster_instance_identifier" {
  description = "The Instance identifier."
  value       = module.aurora-mysql.db_cluster_instance_identifier
}
output "db_cluster_instance_id" {
  description = "The Instance identifier."
  value       = module.aurora-mysql.db_cluster_instance_id
}
output "db_cluster_instance_writer" {
  ...
  value       = module.aurora-mysql.db_cluster_instance_writer
}
output "db_cluster_instance_availability_zone" {
  description = "TThe availability zone of the instance."
  value       = module.aurora-mysql.db_cluster_instance_availability_zone
}
output "db_cluster_instance_endpoint" {
  description = "The DNS address for this instance. May not be writable."
  value       = module.aurora-mysql.db_cluster_instance_endpoint
}
output "db_cluster_instance_engine" {
  description = "The database engine."
  value       = module.aurora-mysql.db_cluster_instance_engine
}
output "db_cluster_instance_engine_version_actual" {
  description = "The database engine version."
  value       = module.aurora-mysql.db_cluster_instance_engine_version_actual
}
output "db_cluster_instance_port" {
  description = "The database port."
  value       = module.aurora-mysql.db_cluster_instance_port
}
output "db_cluster_instance_storage_encrypted" {
  description = "Specifies whether the DB cluster is encrypted."
  value       = module.aurora-mysql.db_cluster_instance_storage_encrypted
}
output "db_cluster_instance_kms_key_id" {
  description = "The ARN for the KMS encryption key if one is set to the cluster."
  value       = module.aurora-mysql.db_cluster_instance_kms_key_id
}
output "db_cluster_instance_dbi_resource_id" {
  description = "The region-unique, immutable identifier for the DB instance."
  value       = module.aurora-mysql.db_cluster_instance_dbi_resource_id
}
output "db_cluster_instance_performance_insights_enabled" {
  description = "Specifies whether Performance Insights is enabled or not."
  value       = module.aurora-mysql.db_cluster_instance_performance_insights_enabled
}
output "db_cluster_instance_performance_insights_kms_key_id" {
  ...
  value       = module.aurora-mysql.db_cluster_instance_performance_insights_kms_key_id
}
output "db_cluster_instance_tags_all" {
  description = "A map of tags assigned to the resource, including those inherited from the provider default_tags configuration block."
  value       = module.aurora-mysql.db_cluster_instance_tags_all
}
...
output "db_cluster_parameter_group_arn" {
  ...
  value       = module.aurora-mysql.db_cluster_parameter_group_arn
}
output "db_cluster_parameter_group_tags_all" {
  description = "A map of tags assigned to the resource, including those inherited from the provider default_tags configuration block."
  value       = module.aurora-mysql.db_cluster_parameter_group_tags_all
}
output "db_cluster_parameter_group_name" {
  description = "Name of the db cluster parameter group."
  value       = module.aurora-mysql.db_cluster_parameter_group_name
}
...
output "db_subnet_group_arn" {
  ...
  value       = module.aurora-mysql.db_subnet_group_arn
}
...
output "db_parameter_group_arn" {
  ...
  value       = module.aurora-mysql.db_parameter_group_arn
}
...
output "security_group_arn" {
  ...
  value       = module.aurora-mysql.security_group_arn
}
...
output "cpu_utilization_too_high_metric_alarm_arn" {
  ...
  value       = module.aurora-mysql.cpu_utilization_too_high_metric_alarm_arn
}
output "cpu_utilization_too_high_metric_alarm_id" {
  ...
  value       = module.aurora-mysql.cpu_utilization_too_high_metric_alarm_id
}
output "disk_queue_depth_too_high_metric_alarm_arn" {
  ...
  value       = module.aurora-mysql.disk_queue_depth_too_high_metric_alarm_arn
}
output "disk_queue_depth_too_high_metric_alarm_id" {
  ...
  value       = module.aurora-mysql.disk_queue_depth_too_high_metric_alarm_id
}
output "disk_free_storage_space_too_low_metric_alarm_arn" {
  ...
  value       = module.aurora-mysql.disk_free_storage_space_too_low_metric_alarm_arn
}
output "disk_free_storage_space_too_low_metric_alarm_id" {
  ...
  value       = module.aurora-mysql.disk_free_storage_space_too_low_metric_alarm_id
}
output "disk_burst_balance_too_low_metric_alarm_arn" {
  ...
  value       = module.aurora-mysql.disk_burst_balance_too_low_metric_alarm_arn
}
output "disk_burst_balance_too_low_metric_alarm_id" {
  ...
  value       = module.aurora-mysql.disk_burst_balance_too_low_metric_alarm_id
}
output "memory_freeable_too_low_metric_alarm_arn" {
  ...
  value       = module.aurora-mysql.memory_freeable_too_low_metric_alarm_arn
}
output "memory_freeable_too_low_metric_alarm_id" {
  description = "The ID of the memory_freeable_too_low cloudwatch metric alarm"
  value       = module.aurora-mysql.memory_freeable_too_low_metric_alarm_id
}
output "memory_swap_usage_too_high_metric_alarm_arn" {
  ...
  value       = module.aurora-mysql.memory_swap_usage_too_high_metric_alarm_arn
}
output "memory_swap_usage_too_high_metric_alarm_id" {
  ...
  value       = module.aurora-mysql.memory_swap_usage_too_high_metric_alarm_id
}
output "anomalous_connection_count_metric_alarm_id" {
  ...
  value       = module.aurora-mysql.anomalous_connection_count_metric_alarm_id
}
output "anomalous_connection_count_metric_alarm_arn" {
  ...
  value       = module.aurora-mysql.anomalous_connection_count_metric_alarm_arn
}
...
output "ssm_param_db_generated_master_password_arn" {
  ...
  value       = module.aurora-mysql.ssm_param_db_generated_master_password_arn
}
output "ssm_param_ddb_generated_master_password_name" {
  ...
  value       = module.aurora-mysql.ssm_param_ddb_generated_master_password_name
}
output "ssm_param_db_generated_master_password_type" {
  ...
  value       = module.aurora-mysql.ssm_param_db_generated_master_password_type
}
output "ssm_param_db_generated_master_password_value" {
  ...
  value       = module.aurora-mysql.ssm_param_db_generated_master_password_value
  sensitive   = true
}
...
output "rds_proxy_sg" {
  description = "A map of security group created for rds proxy"
  value       = module.main_security_group
  sensitive   = true
