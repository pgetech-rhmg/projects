...
variable "custom_instance_names" {
  description = "(Optional) List of custom names for cluster instances. If provided, the list length must match cluster_instance_count. If not provided, defaults to identifier-0, identifier-1, etc. for backward compatibility. Example: ['mydb-writer', 'mydb-reader-1', 'mydb-reader-2']"
  type        = list(string)
  default     = []
}

#uncomment the following lines to use AD authentication
# variable "domain_directory_service_id" {
#   description = "The ID of the Directory Service Active Directory domain to create the instance in"
#   type        = string

# }

# variable "domain_ad_iam_role_name" {
