 ...
 * Terraform module which creates an RDS SQL Server Database.
 *
 * Pre-Requisites:
...
#
#  Filename    : modules/rds/examples/rds_sqlserver/main.tf
#  Date        : 5/26/2022
#  Author      : PGE
#  Description : Example of RDS SQL Server module
#
terraform {
...
module "rds_sqlserver" {
  ...
  create_iam_role_association = var.create_iam_role_association
