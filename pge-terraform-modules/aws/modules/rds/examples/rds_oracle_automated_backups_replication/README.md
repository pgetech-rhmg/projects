...
| <a name="provider_aws.replica"></a> [aws.replica](#provider\_aws.replica) | >= 5.0 |
...
| <a name="input_s3_bucket_arn"></a> [s3\_bucket\_arn](#input\_s3\_bucket\_arn) | Required for this example.  Existing S3 bucket name for RDS export/import | `string` | n/a | yes |
