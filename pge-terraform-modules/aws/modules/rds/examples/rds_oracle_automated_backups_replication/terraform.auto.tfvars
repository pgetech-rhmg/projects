...
kms_name            = "cross-region-kms-rds-oracle"
...
db_name  = "ORCLTF"
username = "admin"
# uncomment password field below and provide your desired password, when the password is not provided, code will generate random password and stores in secretsmanager
#password                    = "pass123xyz2023alpha"
# when manage_master_user_password is set to true, password even when provided is ignored
