...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lmdbsched"></a> [lmdbsched](#module\_lmdbsched) | ../../ | n/a |
...
| <a name="input_branch"></a> [branch](#input\_branch) | branch used to create the Lambda | `string` | n/a | yes |
| <a name="input_compliance"></a> [compliance](#input\_compliance) | n/a | `list(string)` | n/a | yes |
| <a name="input_create_lmdbsched"></a> [create\_lmdbsched](#input\_create\_lmdbsched) | Whether to create a Lambda instance | `bool` | `false` | no |
...
| <a name="input_prefix"></a> [prefix](#input\_prefix) | The prefix prepended to resource names | `string` | n/a | yes |
