...
| Name | Type |
|------|------|
| [aws_vpc_endpoint_service.gateway_load_balancer](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/vpc_endpoint_service) | resource |
...
| <a name="input_gateway_load_balancer_arns"></a> [gateway\_load\_balancer\_arns](#input\_gateway\_load\_balancer\_arns) | A list of gateway\_load\_balancer\_arns | `list(string)` | n/a | yes |
...
| <a name="output_vpc_endpoint_service_availability_zones_gatewaylb"></a> [vpc\_endpoint\_service\_availability\_zones\_gatewaylb](#output\_vpc\_endpoint\_service\_availability\_zones\_gatewaylb) | The Availability Zones in which the service for the Gateway Load Balancer is available. |
| <a name="output_vpc_endpoint_service_base_endpoint_dns_names_gatewaylb"></a> [vpc\_endpoint\_service\_base\_endpoint\_dns\_names\_gatewaylb](#output\_vpc\_endpoint\_service\_base\_endpoint\_dns\_names\_gatewaylb) | The DNS names for the service for the Gateway Load Balancer. |
...
| <a name="output_vpc_endpoint_service_state_gatewaylb"></a> [vpc\_endpoint\_service\_state\_gatewaylb](#output\_vpc\_endpoint\_service\_state\_gatewaylb) | Verification state of the VPC endpoint service for the Gateway Load Balancer. Consumers of the endpoint service can use the private name only when the state is verified. |
