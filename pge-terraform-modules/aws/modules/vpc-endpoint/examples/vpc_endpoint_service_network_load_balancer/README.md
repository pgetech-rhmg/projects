...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_nlb1"></a> [nlb1](#module\_nlb1) | terraform-aws-modules/alb/aws | 8.7.0 |
| <a name="module_nlb2"></a> [nlb2](#module\_nlb2) | terraform-aws-modules/alb/aws | 8.7.0 |
| <a name="module_tags"></a> [tags](#module\_tags) | app.terraform.io/pgetech/tags/aws | 0.1.2 |
| <a name="module_vpc_endpoint_service_network_load_balancer"></a> [vpc\_endpoint\_service\_network\_load\_balancer](#module\_vpc\_endpoint\_service\_network\_load\_balancer) | ../../modules/vpce_service_network_loadbalancer | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_vpc_endpoint_service_arn_networklb"></a> [vpc\_endpoint\_service\_arn\_networklb](#output\_vpc\_endpoint\_service\_arn\_networklb) | The ARN of the VPC endpoint service |
| <a name="output_vpc_endpoint_service_availability_zones_networklb"></a> [vpc\_endpoint\_service\_availability\_zones\_networklb](#output\_vpc\_endpoint\_service\_availability\_zones\_networklb) | The Availability Zones in which the service is available. |
| <a name="output_vpc_endpoint_service_base_endpoint_dns_names_networklb"></a> [vpc\_endpoint\_service\_base\_endpoint\_dns\_names\_networklb](#output\_vpc\_endpoint\_service\_base\_endpoint\_dns\_names\_networklb) | The DNS names for the service. |
| <a name="output_vpc_endpoint_service_id_networklb"></a> [vpc\_endpoint\_service\_id\_networklb](#output\_vpc\_endpoint\_service\_id\_networklb) | The ID of the VPC endpoint service. |
...
| <a name="output_vpc_endpoint_service_state_networklb"></a> [vpc\_endpoint\_service\_state\_networklb](#output\_vpc\_endpoint\_service\_state\_networklb) | The state of the VPC endpoint service. |
