...
| <a name="module_vpc_endpoint_without_policy"></a> [vpc\_endpoint\_without\_policy](#module\_vpc\_endpoint\_without\_policy) | ../../ | n/a |
...
| <a name="input_service_wo_policy"></a> [service\_wo\_policy](#input\_service\_wo\_policy) | Additional AWS service for testing, similar to variable 'service\_name' but which doesn't support vpce policy | `string` | `null` | no |
