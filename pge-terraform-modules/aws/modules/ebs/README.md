# AWS EBS Terraform module

 Terraform base module for deploying and managing EBS modules (EBS from snapshot, EBS with size) on Amazon Web Services (AWS). 

 EBS Modules can be found at `ebs/modules/*`

 EBS Modules examples can be found at `ebs/examples/*`
<!-- BEGIN_TF_DOCS -->
# AWS EBS module
...
| <a name="input_size"></a> [size](#input\_size) | The size of the drive in GiBs | `string` | n/a | yes |
