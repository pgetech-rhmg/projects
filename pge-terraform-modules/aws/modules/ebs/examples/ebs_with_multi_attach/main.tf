...
*/
#
#  Filename    : modules/ebs/examples/ebs_multi_attach_enabled/main.tf
#  Date        : 07 Feb 2022
#  Author      : TCS
#  Description : creation of ebs
#
...
module "ebs" {
  ...
  instance_id          = [module.ec2_01.id, module.ec2_02.id]
