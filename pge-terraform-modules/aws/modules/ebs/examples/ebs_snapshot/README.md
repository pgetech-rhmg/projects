<!-- BEGIN_TF_DOCS -->
# AWS EBS ebs\_snapshot module example
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_ebs"></a> [ebs](#module\_ebs) | ../../modules/ebs_from_snapshot | n/a |
...
| <a name="input_ebs_snapshot_id"></a> [ebs\_snapshot\_id](#input\_ebs\_snapshot\_id) | A snapshot to base the EBS volume. | `string` | n/a | yes |
