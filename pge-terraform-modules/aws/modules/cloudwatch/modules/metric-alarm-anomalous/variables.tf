...
variable "threshold_metric_id" {
  description = "Make this value match the ID of the ANOMALY_DETECTION_BAND function."
  type        = string
}
...
variable "datapoints_to_alarm" {
  ...
  default     = null
  validation {
    condition     = var.datapoints_to_alarm == null ? true : var.datapoints_to_alarm > 0 && floor(var.datapoints_to_alarm) == var.datapoints_to_alarm
    error_message = "datapoints_to_alarm must be an integer >= 1"
  }
}
