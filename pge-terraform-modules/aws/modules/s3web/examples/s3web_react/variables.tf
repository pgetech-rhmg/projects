...
variable "github_repo_url" {
  description = "Enter the github repo url"
  type        = string
}

variable "github_branch" {
  description = "Enter the github branch name"
  type        = string
}
...
variable "s3web_type" {
  description = "s3web type to be created"
  type        = string
  validation {
...
variable "bucketType" {
  description = "type of s3 bucket, values likes staticweb, etc"
  type        = string
  default     = "StaticWeb2"
}
