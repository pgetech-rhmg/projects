...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_authentication_profile"></a> [authentication\_profile](#module\_authentication\_profile) | ../../modules/authentication_profile | n/a |
...
| <a name="module_endpoint_access"></a> [endpoint\_access](#module\_endpoint\_access) | ../../modules/endpoint_access | n/a |
...
| <a name="module_usage_limit"></a> [usage\_limit](#module\_usage\_limit) | ../../modules/usage_limit | n/a |
...
|------|-------------|------|---------|:--------:|
| <a name="input_AllowDBUserOverride"></a> [AllowDBUserOverride](#input\_AllowDBUserOverride) | Variables for content in JSON file | `number` | n/a | yes |
| <a name="input_AppID"></a> [AppID](#input\_AppID) | Identify the application this asset belongs to by its AMPS APP ID.Format = APP-#### | `number` | n/a | yes |
| <a name="input_App_ID"></a> [App\_ID](#input\_App\_ID) | Variables for content in JSON file | `string` | n/a | yes |
| <a name="input_CRIS"></a> [CRIS](#input\_CRIS) | Cyber Risk Impact Score High, Medium, Low (only one) | `string` | n/a | yes |
| <a name="input_Client_ID"></a> [Client\_ID](#input\_Client\_ID) | Variables for content in JSON file | `string` | n/a | yes |
...
| <a name="input_availability_zone"></a> [availability\_zone](#input\_availability\_zone) | The EC2 Availability Zone (AZ) in which you want Amazon Redshift to provision the cluster. For example, if you have several EC2 instances running in a specific Availability Zone, then you might want the cluster to be provisioned in the same zone in order to decrease network latency. Can only be changed if availability\_zone\_relocation\_enabled is true. | `string` | n/a | yes |
| <a name="input_availability_zone_relocation_enabled"></a> [availability\_zone\_relocation\_enabled](#input\_availability\_zone\_relocation\_enabled) | If true, the cluster can be relocated to another availabity zone, either automatically by AWS or when requested. Default is false. Available for use on clusters from the RA3 instance family. | `bool` | n/a | yes |
| <a name="input_aws_region"></a> [aws\_region](#input\_aws\_region) | AWS region | `string` | n/a | yes |
| <a name="input_aws_role"></a> [aws\_role](#input\_aws\_role) | AWS role to assume | `string` | n/a | yes |
| <a name="input_breach_action"></a> [breach\_action](#input\_breach\_action) | The action that Amazon Redshift takes when the limit is reached. The default is log. | `string` | n/a | yes |
...
| <a name="input_number_of_nodes"></a> [number\_of\_nodes](#input\_number\_of\_nodes) | The number of compute nodes in the cluster. | `number` | n/a | yes |
...
| <a name="output_endpoint_vpc_endpoint"></a> [endpoint\_vpc\_endpoint](#output\_endpoint\_vpc\_endpoint) | The connection endpoint for connecting to an Amazon Redshift cluster through the proxy. |
