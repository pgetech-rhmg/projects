#
# Filename    : modules/efs/examples/efs_lifecycle/main.tf
# Date        : 2 february 2022
# Author      : TCS
# Description : Efs usage with lifecycle policy
...
module "efs" {
  ...
  enable_transition_to_primary_storage_class = var.enable_transition_to_primary_storage_class
