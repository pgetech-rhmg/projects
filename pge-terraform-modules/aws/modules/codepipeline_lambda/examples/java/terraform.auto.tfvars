...
ssm_parameter_artifactory_repo_name = "/jfrog/artifactory/ccoe_maven_repo" #ccoe-cicd-maven-virtual
...
project_key  = "lambda-java-ccoe-test" #project key for sonarqube scan
project_name = "lambda-java-ccoe-test" #Make sure to project Name for sonarqube scan which will be used to create a project in sonarqube

project_root_directory    = "reference-pipelines/java/lambda/java17-examples" #if source code is not in the root directory
