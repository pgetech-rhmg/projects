...
*/
#
#  Filename    : aws/modules/codepipeline/examples/java/main.tf
#  Date        : 01 October 2024
#  Author      : PGE
#  Description : The terraform module creates a codepipeline for Lambda Java
...
module "lambda_function" {
  ...
  source_code = {
    ...
    filename = "HandlerIntegerJava17.java" #this is a dummy file, actual file will be added via codepipeline
  }
