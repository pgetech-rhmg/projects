<!-- BEGIN_TF_DOCS -->
# AWS codepipeline lambda module for docker deployments
# This module creates a codepipeline for Lambda functions using image deployments will use seprate buildspec for codepublish(container\_lambda\_java)
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_internal_lambda"></a> [internal\_lambda](#module\_internal\_lambda) | ../internal/ | n/a |
...
| <a name="input_artifactory_docker_registry"></a> [artifactory\_docker\_registry](#input\_artifactory\_docker\_registry) | Enter the name value of JFrog Artifactory | `string` | `""` | no |
...
| <a name="input_cache_modes_codebuild"></a> [cache\_modes\_codebuild](#input\_cache\_modes\_codebuild) | Specifies settings that AWS CodeBuild uses to store and reuse build dependencies | `string` | `"LOCAL_DOCKER_LAYER_CACHE"` | no |
| <a name="input_cache_modes_codepublish"></a> [cache\_modes\_codepublish](#input\_cache\_modes\_codepublish) | Specifies settings that AWS CodeBuild uses to store and reuse build dependencies | `string` | `"LOCAL_DOCKER_LAYER_CACHE"` | no |
...
| <a name="input_create_ecr_repository"></a> [create\_ecr\_repository](#input\_create\_ecr\_repository) | Whether to create an ECR repository for the Docker image. Set to false if using an existing repository. | `bool` | `true` | no |
...
| <a name="input_docker_image_name"></a> [docker\_image\_name](#input\_docker\_image\_name) | Enter the docker image name for docker build (also used as ECR repository name if create\_ecr\_repository is true) | `string` | n/a | yes |
...
| <a name="input_environment_privileged_mode_codebuild"></a> [environment\_privileged\_mode\_codebuild](#input\_environment\_privileged\_mode\_codebuild) | Whether to enable privileged mode for the CodeBuild project. Required for Docker builds. | `bool` | `true` | no |
| <a name="input_environment_privileged_mode_codepublish"></a> [environment\_privileged\_mode\_codepublish](#input\_environment\_privileged\_mode\_codepublish) | Whether to enable privileged mode for the CodePublish project. Required for Docker builds. | `bool` | `true` | no |
| <a name="input_environment_privileged_mode_codescan"></a> [environment\_privileged\_mode\_codescan](#input\_environment\_privileged\_mode\_codescan) | Whether to enable privileged mode for the CodeScan project. Required for Docker builds. | `bool` | `false` | no |
...
| <a name="input_secretsmanager_wiz_client_id"></a> [secretsmanager\_wiz\_client\_id](#input\_secretsmanager\_wiz\_client\_id) | Enter the name of wiz client id stored in secrets manager | `string` | `""` | no |
| <a name="input_secretsmanager_wiz_client_secret"></a> [secretsmanager\_wiz\_client\_secret](#input\_secretsmanager\_wiz\_client\_secret) | Enter the token of wiz client secret stored in secrets manager | `string` | `""` | no |
...
| <a name="input_unit_test_commands"></a> [unit\_test\_commands](#input\_unit\_test\_commands) | Enter the unit test commands for docker webapp | `string` | n/a | yes |
