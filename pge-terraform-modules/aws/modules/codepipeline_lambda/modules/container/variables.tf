...
variable "custom_codescan_policy_file" {
  description = "add custom codescan policy file for codescan project, if needed"
  type        = string
  default     = null
}

variable "custom_codepublish_policy_file" {
  description = "add custom codepublish policy file for code publish project, if needed"
  type        = string
  default     = null
}
...
variable "unit_test_commands" {
  description = "Enter the unit test commands for docker webapp"
  type        = string
}
...
variable "docker_image_name" {
  description = "Enter the docker image name for docker build (also used as ECR repository name if create_ecr_repository is true)"
  type        = string
}
