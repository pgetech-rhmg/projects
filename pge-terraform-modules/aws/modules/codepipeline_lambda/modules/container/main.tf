 ...
 * # This module creates a codepipeline for Lambda functions using image deployments will use seprate buildspec for codepublish(container_lambda_java)
 * Terraform module which creates SAF2.0 codepipeline in AWS
*/
#  Filename    : aws/modules/codepipeline_lambda/modules/docker/main.tf
#  Date        : 04 December 2024
#  Author      : PGE
#  Description : The terraform module creates a codepipeline for Lambda with Docker containerization
...
# Module : Codepipeline
# Description : This terraform module creates codepipeline for Lambda with Docker containerization

module "internal_lambda" {
  source = "../internal/"

  codebuildapp_language = "container_java"
  ...
  environment_privileged_mode_codebuild   = var.environment_privileged_mode_codebuild
  ...
  environment_privileged_mode_codescan    = var.environment_privileged_mode_codescan
  ...
  environment_privileged_mode_codepublish = var.environment_privileged_mode_codepublish
