...
locals {
  ...
  codescan_buildspec = {
    ...
    "dotnet"         = module.codebuild_codescan.codescan_buildspec_dotnet
    "container_java" = module.codebuild_codescan.codescan_buildspec_java_lambda_container
  }
  codepublish_buildspec = {
    "python"         = module.codebuild_codepublish.codepublish_buildspec_python
    "nodejs"         = module.codebuild_codepublish.codepublish_buildspec_nodejs
    "java"           = module.codebuild_codepublish.codepublish_buildspec_java
    "dotnet"         = module.codebuild_codepublish.codepublish_buildspec_dotnet
    "container_java" = module.codebuild_codepublish.codepublish_buildspec_java_lambda_container
  }
...
module "codebuild_project" {
  ...
  environment_privileged_mode = var.environment_privileged_mode_codebuild
}
...
module "codebuild_codescan" {
  ...
  environment_variables = concat([
    ...
    },
    {
      ...
      value = jsonencode(merge(var.tags, var.optional_tags))
      type  = "PLAINTEXT"
    }
  ], var.environment_variables_codescan_stage)
  environment_privileged_mode = var.environment_privileged_mode_codescan
}
...
module "codebuild_codepublish" {
  ...
  environment_privileged_mode = var.environment_privileged_mode_codepublish
}
