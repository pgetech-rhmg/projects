...
*/
#
# Filename    : modules/s3/s3_replication/main.tf
# Date        : 14 July 2022
    ...
    content {
      ...
      dynamic "destination" {
        ...
        content {
          ...
          #SAF 2.0 control mandatory controls : replication_time, metrics 
          replication_time {
            # Valid values: "Enabled" or "Disabled"
            status = "Enabled"

            time {
              minutes = destination.value.replication_time.minutes
            }
          }
