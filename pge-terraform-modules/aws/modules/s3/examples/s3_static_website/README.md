...
| <a name="module_s3_static_website"></a> [s3\_static\_website](#module\_s3\_static\_website) | ../../modules/s3_static_website | n/a |
...
| <a name="input_custom_bucket_name"></a> [custom\_bucket\_name](#input\_custom\_bucket\_name) | s3 bucket name | `string` | n/a | yes |
