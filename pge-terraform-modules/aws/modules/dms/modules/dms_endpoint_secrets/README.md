...
| <a name="input_source_endpoint_secrets_manager_access_role_arn"></a> [source\_endpoint\_secrets\_manager\_access\_role\_arn](#input\_source\_endpoint\_secrets\_manager\_access\_role\_arn) | ARN of the IAM role that specifies AWS DMS as the trusted entity and has the required permissions to access the value in SecretsManagerSecret. | `string` | `null` | no |
| <a name="input_source_endpoint_secrets_manager_arn"></a> [source\_endpoint\_secrets\_manager\_arn](#input\_source\_endpoint\_secrets\_manager\_arn) | Full ARN, partial ARN, or friendly name of the SecretsManagerSecret that contains the endpoint connection details. Supported only for source\_endpoint\_engine\_name as aurora, aurora-postgresql, mariadb, mongodb, mysql, oracle, postgres, redshift or sqlserver. | `string` | `null` | no |
...
| <a name="input_target_endpoint_secrets_manager_access_role_arn"></a> [target\_endpoint\_secrets\_manager\_access\_role\_arn](#input\_target\_endpoint\_secrets\_manager\_access\_role\_arn) | ARN of the IAM role that specifies AWS DMS as the trusted entity and has the required permissions to access the value in SecretsManagerSecret. | `string` | n/a | yes |
| <a name="input_target_endpoint_secrets_manager_arn"></a> [target\_endpoint\_secrets\_manager\_arn](#input\_target\_endpoint\_secrets\_manager\_arn) | Full ARN, partial ARN, or friendly name of the SecretsManagerSecret that contains the endpoint connection details. Supported only for target\_endpoint\_engine\_name as aurora, aurora-postgresql, mariadb, mongodb, mysql, oracle, postgres, redshift or sqlserver. | `string` | n/a | yes |
