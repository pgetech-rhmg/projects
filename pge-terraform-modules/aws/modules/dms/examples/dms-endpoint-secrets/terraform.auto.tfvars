...
target_certificate_arn        = null # certifcate arn required if target_endpoint_ssl_mode if the value of source_endpoint_ssl_mode is "verify-ca" or "require"

# Secrets key is a pre-requisite and must be existing.
...
# SNS and event_subscription
snstopic_name         = "sns_topic_test"    # Name of the SNS topic
