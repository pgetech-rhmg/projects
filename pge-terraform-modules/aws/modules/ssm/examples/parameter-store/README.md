...
| <a name="input_kms_name"></a> [kms\_name](#input\_kms\_name) | The KMS name to encrypt data in store. | `string` | n/a | yes |
...
| <a name="output_type"></a> [type](#output\_type) | Type of the ssm parameter. |
| <a name="output_version"></a> [version](#output\_version) | Version of the ssm parameter. |
