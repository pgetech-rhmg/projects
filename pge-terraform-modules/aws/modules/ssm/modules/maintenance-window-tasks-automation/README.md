...
| <a name="input_maintenance_window_task_type"></a> [maintenance\_window\_task\_type](#input\_maintenance\_window\_task\_type) | The type of task being registered. Valid values: AUTOMATION, LAMBDA, RUN\_COMMAND or STEP\_FUNCTIONS | `string` | `"AUTOMATION"` | no |
...
| <a name="input_task_invocation_automation_parameters"></a> [task\_invocation\_automation\_parameters](#input\_task\_invocation\_automation\_parameters) | The parameters for an AUTOMATION task type. | `list(any)` | `[]` | no |
