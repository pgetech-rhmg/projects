...
# Filename    : modules/maintenance-window-tasks-lambda/main.tf
# Date        : 13 April 2023
# Author      : PGE
# Description : Provides an SSM Maintenance Window Lambda Task resource
#
...
resource "aws_ssm_maintenance_window_task" "task_patches" {
  ...
  task_invocation_parameters {
    ...
    dynamic "lambda_parameters" {
      for_each = toset(var.task_invocation_lambda_parameters)
      content {
