...
| <a name="input_recipe_version"></a> [recipe\_version](#input\_recipe\_version) | Image Builder Recipe Version. | `string` | `"0.0.2"` | no |
...
| <a name="input_stack_set_name"></a> [stack\_set\_name](#input\_stack\_set\_name) | Name of StackSet to distribute the golden AMI | `string` | `"current-ami-id-linux-prod"` | no |
