# mrad-webcore-lmpttup module

This module deploys the PTT Update Lambda from a given S3 bucket.
...
| <a name="module_ptt_update_lambda"></a> [ptt\_update\_lambda](#module\_ptt\_update\_lambda) | app.terraform.io/pgetech/lambda/aws//modules/lambda_s3_bucket | 0.0.17 |
...
| Name | Type |
|------|------|
| [aws_cloudwatch_event_rule.lambda_rule](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_event_rule) | resource |
...
| [aws_lambda_permission.ptt_update](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_permission) | resource |
...
| <a name="input_poll_rate"></a> [poll\_rate](#input\_poll\_rate) | n/a | `map(any)` | <pre>{<br/>  "Dev": {<br/>    "rate": "rate(5 minutes)"<br/>  },<br/>  "Prod": {<br/>    "rate": "rate(5 minutes)"<br/>  },<br/>  "QA": {<br/>    "rate": "rate(5 minutes)"<br/>  }<br/>}</pre> | no |
