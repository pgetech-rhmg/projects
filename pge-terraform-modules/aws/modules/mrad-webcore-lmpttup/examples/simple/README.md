...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lmpttup"></a> [lmpttup](#module\_lmpttup) | ../../ | n/a |
...
| <a name="input_create_lmpttup"></a> [create\_lmpttup](#input\_create\_lmpttup) | Whether to create a Lambda instance | `bool` | `false` | no |
