...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_codebuild_codepublish"></a> [codebuild\_codepublish](#module\_codebuild\_codepublish) | app.terraform.io/pgetech/codebuild/aws | 0.1.2 |
| <a name="module_codebuild_codescan"></a> [codebuild\_codescan](#module\_codebuild\_codescan) | app.terraform.io/pgetech/codebuild/aws | 0.1.2|
...
| <a name="module_codebuild_project"></a> [codebuild\_project](#module\_codebuild\_project) | app.terraform.io/pgetech/codebuild/aws | 0.1.2 |
...
| <a name="module_security-group"></a> [security-group](#module\_security-group) | app.terraform.io/pgetech/security-group/aws | 0.1.0|
...
| [aws_s3_bucket.s3web](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/s3_bucket) | data source |
...
| <a name="input_artifact_store_location_bucket"></a> [artifact\_store\_location\_bucket](#input\_artifact\_store\_location\_bucket) | The location where AWS CodePipeline stores artifacts for a pipeline; currently only S3 is supported. | `string` | `null` | no |
...
| <a name="input_artifactory_host"></a> [artifactory\_host](#input\_artifactory\_host) | Enter the name of jfrog artifactory host | `string` | `"https://jfrog.io.pge.com"` | no |
| <a name="input_artifactory_repo_key"></a> [artifactory\_repo\_key](#input\_artifactory\_repo\_key) | JFrog npm Artifactory to use in Terraform CodePipeline to pull the npm dependencies | `string` | `"ccoe-cicd-npm-virtual"` | no |
...
| <a name="input_codebuild_sc_token"></a> [codebuild\_sc\_token](#input\_codebuild\_sc\_token) | For GitHub or GitHub Enterprise, this is the personal access token. | `string` | `null` | no |
| <a name="input_codebuild_source_buildspec"></a> [codebuild\_source\_buildspec](#input\_codebuild\_source\_buildspec) | Build specification to use for this build project's related builds | `string` | `null` | no |
| <a name="input_codepipeline_name"></a> [codepipeline\_name](#input\_codepipeline\_name) | The name of the pipeline. | `string` | n/a | yes |
| <a name="input_codepipeline_role_arn"></a> [codepipeline\_role\_arn](#input\_codepipeline\_role\_arn) | A service role Amazon Resource Name (ARN) that grants AWS CodePipeline permission to make calls to AWS services on your behalf. | `string` | `null` | no |
...
| <a name="input_codepipeline_type"></a> [codepipeline\_type](#input\_codepipeline\_type) | Enter the type of the codepipeline application | `string` | `null` | no |
...
| <a name="input_secretsmanager_artifactory_token"></a> [secretsmanager\_artifactory\_token](#input\_secretsmanager\_artifactory\_token) | Enter the token of artifactory stored in secrets manager | `string` | `"jfrog_credentials:jfrog_token"` | no |
| <a name="input_secretsmanager_artifactory_user"></a> [secretsmanager\_artifactory\_user](#input\_secretsmanager\_artifactory\_user) | Enter the name of jfrog artifactory user stored in secrets manager | `string` | `"jfrog_credentials:jfrog_user"` | no |
...
| <a name="input_secretsmanager_sonar_token"></a> [secretsmanager\_sonar\_token](#input\_secretsmanager\_sonar\_token) | Enter the token of SonarQube stored in secrets manager | `string` | `"sonarqube_credentials:sonar_token"` | no |
...
| <a name="input_sonar_host"></a> [sonar\_host](#input\_sonar\_host) | Enter the value of SonarQube host | `string` | `"/sonarqube/host"` | no |
...
| <a name="output_codebuild_codepublish_project_id"></a> [codebuild\_codepublish\_project\_id](#output\_codebuild\_codepublish\_project\_id) | Name or ARN of the CodePublish project |
| <a name="output_codebuild_codescan_project_id"></a> [codebuild\_codescan\_project\_id](#output\_codebuild\_codescan\_project\_id) | Name or ARN of the CodeScan project |
