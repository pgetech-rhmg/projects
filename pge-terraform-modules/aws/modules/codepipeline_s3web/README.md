...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_internal_s3web"></a> [internal\_s3web](#module\_internal\_s3web) | ./modules/internal/ | n/a |
...
| <a name="input_pollchanges"></a> [pollchanges](#input\_pollchanges) | Periodically check the location of your source content and run the pipeline if changes are detected | `string` | `"false"` | no |
...
| <a name="input_repo_name"></a> [repo\_name](#input\_repo\_name) | Github repository name of the application to be built | `string` | `null` | no |
