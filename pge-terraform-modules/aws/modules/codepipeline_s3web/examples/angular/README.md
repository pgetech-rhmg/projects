...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_codepipeline"></a> [codepipeline](#module\_codepipeline) | ../../modules/angular | n/a |
| <a name="module_codepipeline_webhook"></a> [codepipeline\_webhook](#module\_codepipeline\_webhook) | app.terraform.io/pgetech/codepipeline_internal/aws//modules/gh_webhook | 0.1.5 |
...
| <a name="input_package_manager"></a> [package\_manager](#input\_package\_manager) | Valid values for package manager are (npm, yarn) | `string` | n/a | yes |
