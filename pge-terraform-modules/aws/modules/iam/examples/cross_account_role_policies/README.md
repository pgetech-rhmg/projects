...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws_cross_account_iam_role"></a> [aws\_cross\_account\_iam\_role](#module\_aws\_cross\_account\_iam\_role) | ../../ | n/a |
...
| <a name="input_name"></a> [name](#input\_name) | Unique name for the role | `string` | n/a | yes |
...
| <a name="input_trusted_aws_principals"></a> [trusted\_aws\_principals](#input\_trusted\_aws\_principals) | A list of AWS accounts allowed to use this cross account role.  Required if the aws\_service variable is not provided. | `list(string)` | `[]` | no | 
