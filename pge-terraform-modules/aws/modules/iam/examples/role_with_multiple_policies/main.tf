...
*/
#
# Filename    : modules/iam/examples/role_with_multiple_policies
# Date        : Nov 22, 2021
# Author      : Sara Ahmad (s7aw@pge.com)
# Description : iam role creation with mutliple type of policies arns, CMS, managed, inlines
#
...
#########################################
# Role Creation with mutliple Polciies
#########################################
module "iam_policy" {
