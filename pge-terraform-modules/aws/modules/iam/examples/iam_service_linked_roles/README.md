...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws_iam_service_linked_roles"></a> [aws\_iam\_service\_linked\_roles](#module\_aws\_iam\_service\_linked\_roles) | ../../modules/iam_service_linked_roles | n/a |
...
| <a name="input_optional_tags"></a> [optional\_tags](#input\_optional\_tags) | Optional\_tags for the slr resource | `map(string)` | `{}` | no | 
