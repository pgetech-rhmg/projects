...
| <a name="module_api_gateway_get_method"></a> [api\_gateway\_get\_method](#module\_api\_gateway\_get\_method) | ../../modules/rest_api_method | n/a |
| <a name="module_api_gateway_key"></a> [api\_gateway\_key](#module\_api\_gateway\_key) | ../../ | n/a |
| <a name="module_api_gateway_options_method"></a> [api\_gateway\_options\_method](#module\_api\_gateway\_options\_method) | ../../modules/rest_api_method | n/a |
| <a name="module_api_gateway_post_method"></a> [api\_gateway\_post\_method](#module\_api\_gateway\_post\_method) | ../../modules/rest_api_method | n/a |
...
| [random_pet.agw](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/pet) | resource |
...
| [template_file.api_policy](https://registry.terraform.io/providers/hashicorp/template/latest/docs/data-sources/file) | data source |
| [template_file.kms_custom_policy](https://registry.terraform.io/providers/hashicorp/template/latest/docs/data-sources/file) | data source |
...
| <a name="input_method_options_api_key_required"></a> [method\_options\_api\_key\_required](#input\_method\_options\_api\_key\_required) | Specify if the method requires an API key | `bool` | n/a | yes |
| <a name="input_method_options_authorization"></a> [method\_options\_authorization](#input\_method\_options\_authorization) | The type of authorization used for the method (NONE, CUSTOM, AWS\_IAM, COGNITO\_USER\_POOLS). | `string` | n/a | yes |
| <a name="input_method_options_cors_enabled"></a> [method\_options\_cors\_enabled](#input\_method\_options\_cors\_enabled) | Specify if CORS is enabled | `bool` | n/a | yes |
| <a name="input_method_options_http_method"></a> [method\_options\_http\_method](#input\_method\_options\_http\_method) | The HTTP Method (GET, POST, PUT, DELETE, HEAD, OPTIONS, ANY). | `string` | n/a | yes |
| <a name="input_method_options_response_parameters"></a> [method\_options\_response\_parameters](#input\_method\_options\_response\_parameters) | A map of request query string parameters and headers that should be passed to the integration. For example: request\_parameters = {"method.request.header.X-Some-Header" = true "method.request.querystring.some-query-param" = true} would define that the header X-Some-Header and the query string some-query-param must be provided in the request. | `map(string)` | n/a | yes |
| <a name="input_method_post_api_key_required"></a> [method\_post\_api\_key\_required](#input\_method\_post\_api\_key\_required) | Specify if the method requires an API key | `bool` | n/a | yes |
| <a name="input_method_post_authorization"></a> [method\_post\_authorization](#input\_method\_post\_authorization) | The type of authorization used for the method (NONE, CUSTOM, AWS\_IAM, COGNITO\_USER\_POOLS). | `string` | n/a | yes |
| <a name="input_method_post_cors_enabled"></a> [method\_post\_cors\_enabled](#input\_method\_post\_cors\_enabled) | Specify if CORS is enabled | `bool` | n/a | yes |
| <a name="input_method_post_http_method"></a> [method\_post\_http\_method](#input\_method\_post\_http\_method) | The HTTP Method (GET, POST, PUT, DELETE, HEAD, OPTIONS, ANY). | `string` | n/a | yes |
| <a name="input_method_post_request_parameters"></a> [method\_post\_request\_parameters](#input\_method\_post\_request\_parameters) | A map of request query string parameters and headers that should be passed to the integration. For example: request\_parameters = {"method.request.header.X-Some-Header" = true "method.request.querystring.some-query-param" = true} would define that the header X-Some-Header and the query string some-query-param must be provided in the request. | `map(string)` | n/a | yes |
...
| <a name="input_options_integration_connection_type"></a> [options\_integration\_connection\_type](#input\_options\_integration\_connection\_type) | The integration input's connectionType. Valid values are INTERNET (default for connections through the public routable internet), and VPC\_LINK (for private connections between API Gateway and a network load balancer in a VPC). | `string` | n/a | yes |
| <a name="input_options_integration_response_parameters"></a> [options\_integration\_response\_parameters](#input\_options\_integration\_response\_parameters) | A map of request query string parameters and headers that should be passed to the backend responder. For example: request\_parameters = { "integration.request.header.X-Some-Other-Header" = "method.request.header.X-Some-Header" }. | `map(string)` | n/a | yes |
| <a name="input_options_integration_type"></a> [options\_integration\_type](#input\_options\_integration\_type) | The integration input's type. Valid values are HTTP (for HTTP backends), MOCK (not calling any real backend), AWS (for AWS services), AWS\_PROXY (for Lambda proxy integration) and HTTP\_PROXY (for HTTP proxy integration). An HTTP or HTTP\_PROXY integration with a connection\_type of VPC\_LINK is referred to as a private integration and uses a VpcLink to connect API Gateway to a network load balancer of a VPC. | `string` | n/a | yes |
...
| <a name="input_post_integration_cache_key_parameters"></a> [post\_integration\_cache\_key\_parameters](#input\_post\_integration\_cache\_key\_parameters) | A list of cache key parameters for the integration. | `list(string)` | n/a | yes |
| <a name="input_post_integration_cache_namespace"></a> [post\_integration\_cache\_namespace](#input\_post\_integration\_cache\_namespace) | The integration's cache namespace. | `string` | n/a | yes |
| <a name="input_post_integration_connection_type"></a> [post\_integration\_connection\_type](#input\_post\_integration\_connection\_type) | The integration input's connectionType. Valid values are INTERNET (default for connections through the public routable internet), and VPC\_LINK (for private connections between API Gateway and a network load balancer in a VPC). | `string` | n/a | yes |
| <a name="input_post_integration_content_handling"></a> [post\_integration\_content\_handling](#input\_post\_integration\_content\_handling) | Specifies how to handle request payload content type conversions. Supported values are CONVERT\_TO\_BINARY and CONVERT\_TO\_TEXT. | `string` | n/a | yes |
| <a name="input_post_integration_http_method"></a> [post\_integration\_http\_method](#input\_post\_integration\_http\_method) | The integration HTTP method (GET, POST, PUT, DELETE, HEAD, OPTIONs, ANY, PATCH) specifying how API Gateway will interact with the back end. Required if type is AWS, AWS\_PROXY, HTTP or HTTP\_PROXY. Not all methods are compatible with all AWS integrations. e.g. Lambda function can only be invoked via POST. | `string` | n/a | yes |
| <a name="input_post_integration_request_parameters"></a> [post\_integration\_request\_parameters](#input\_post\_integration\_request\_parameters) | A map of request query string parameters and headers that should be passed to the backend responder. For example: request\_parameters = { "integration.request.header.X-Some-Other-Header" = "method.request.header.X-Some-Header" }. | `map(string)` | n/a | yes |
| <a name="input_post_integration_type"></a> [post\_integration\_type](#input\_post\_integration\_type) | The integration input's type. Valid values are HTTP (for HTTP backends), MOCK (not calling any real backend), AWS (for AWS services), AWS\_PROXY (for Lambda proxy integration) and HTTP\_PROXY (for HTTP proxy integration). An HTTP or HTTP\_PROXY integration with a connection\_type of VPC\_LINK is referred to as a private integration and uses a VpcLink to connect API Gateway to a network load balancer of a VPC. | `string` | n/a | yes |
