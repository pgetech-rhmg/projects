...
#rest_api policy
# pVpcEndpoint     = "vpce-09e783836bb2de47b" # internal SharedServicesV2Prod VPC Endpoint (without going through F5)
...
method_options_cors_enabled     = true #For a MOCK integration, cors_enabled needs to be set to true. This will enable CORS by creating an OPTIONS method.
