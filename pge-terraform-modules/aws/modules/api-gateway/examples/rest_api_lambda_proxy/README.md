...
| <a name="module_lambda_function_authorization"></a> [lambda\_function\_authorization](#module\_lambda\_function\_authorization) | app.terraform.io/pgetech/lambda/aws | 0.1.3 |
| <a name="module_security_group_auth_lambda"></a> [security\_group\_auth\_lambda](#module\_security\_group\_auth\_lambda) | app.terraform.io/pgetech/security-group/aws | 0.1.1 |
...
| <a name="input_auth_function_name"></a> [auth\_function\_name](#input\_auth\_function\_name) | Unique name for your Lambda Function | `string` | n/a | yes |
| <a name="input_auth_handler"></a> [auth\_handler](#input\_auth\_handler) | Function entrypoint in your code | `string` | n/a | yes |
| <a name="input_auth_lambda_sg_name"></a> [auth\_lambda\_sg\_name](#input\_auth\_lambda\_sg\_name) | name of the security group | `string` | n/a | yes |
| <a name="input_auth_local_zip_source_directory"></a> [auth\_local\_zip\_source\_directory](#input\_auth\_local\_zip\_source\_directory) | Package entire contents of this directory into the archive | `string` | n/a | yes |
| <a name="input_auth_runtime"></a> [auth\_runtime](#input\_auth\_runtime) | Identifier of the function's runtime | `string` | n/a | yes |
