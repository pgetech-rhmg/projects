# mrad-webcore-lmgissync example
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lmgissync"></a> [lmgissync](#module\_lmgissync) | ../../ | n/a |
...
| <a name="input_create_lmgissync"></a> [create\_lmgissync](#input\_create\_lmgissync) | Whether to create a Lambda instance | `bool` | `false` | no |
...
| <a name="input_git_branch"></a> [git\_branch](#input\_git\_branch) | The branch from which this Lambda is built | `string` | n/a | yes |
...
| <a name="input_prefix"></a> [prefix](#input\_prefix) | value to prefix all resources with | `string` | n/a | yes |
